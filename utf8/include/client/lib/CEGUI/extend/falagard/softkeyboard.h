#ifndef PAP_CLIENT_LIB_CEGUI_EXTEND_FALAGARD_SOFTKEYBOARD_H_
#define PAP_CLIENT_LIB_CEGUI_EXTEND_FALAGARD_SOFTKEYBOARD_H_
#pragma once
...
#endif //PAP_CLIENT_LIB_CEGUI_EXTEND_FALAGARD_SOFTKEYBOARD_H_
