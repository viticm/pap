#ifndef PAP_CLIENT_LIB_CEGUI_EXTEND_FALAGARD_IAISTORY_H_
#define PAP_CLIENT_LIB_CEGUI_EXTEND_FALAGARD_IAISTORY_H_
...
#endif //PAP_CLIENT_LIB_CEGUI_EXTEND_FALAGARD_IAISTORY_H_
