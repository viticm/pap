...
namespace CEGUI
{
	...
	public:
		...
		*/
		...
		/*!
		\brief
		Return the texture name of the window background.
		*/
		String			getBackgroundName(void) const { return d_backgroundName; }
		/*!
		\brief
		Set the window name that control show or hide.
		*/
		void			setBackgroundName(const String& texName);
	...
	protected:
		...
		*************************************************************************/
		...
		String              d_backgroundName;           //!< The texture name of the window background
		/*************************************************************************
	...
	private:
		...
		*************************************************************************/
		...
		static FalagardMeshWindowProperties::BackgroundName	d_backgroundNameProperty;
