#ifndef PAP_CLIENT_LIB_CEGUI_EXTEND_FALAGARD_IACTIONBUTTON_H_
#define PAP_CLIENT_LIB_CEGUI_EXTEND_FALAGARD_IACTIONBUTTON_H_
...
namespace CEGUI
{
  ...
  public:
    ...
    */
    ...
    /*!
    \brief
    Set the percentage image
    */
    virtual void      setPercentageImage(const String& animateName, int cur, int total) = 0;
    virtual void      cleanPercentageImage(void) = 0;
    ...
    */
    ...
    virtual void      setFlashEnable( bool bEnable ) = 0; 

    virtual void      FirReSet( void) = 0; 
  };
}
#endif //PAP_CLIENT_LIB_CEGUI_EXTEND_FALAGARD_IACTIONBUTTON_H_
