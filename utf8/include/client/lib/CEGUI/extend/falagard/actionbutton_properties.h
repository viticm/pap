#ifndef PAP_CLIENT_LIB_CEGUI_EXTEND_FALAGARD_ACTIONBUTTON_PROPERTIES_H_
#define PAP_CLIENT_LIB_CEGUI_EXTEND_FALAGARD_ACTIONBUTTON_PROPERTIES_H_
  ...
  */
  namespace FalagardActionButtonProperties
  {
    ...
    */
    ...
    class FlashAnimate : public Property
    {
    public:
      FlashAnimate() : Property(
        "FlashAnimate",
        "",
        "")
      {}
    ...
    class BackImage : public Property
    {
    public:
      BackImage() : Property(
        "BackImage",
    ...
    class UseDefaultTooltip: public Property
    {
    public:
      UseDefaultTooltip() : Property(
        "UseDefaultTooltip",
        "",
        "")
      {}
...
#endif //PAP_CLIENT_LIB_CEGUI_EXTEND_FALAGARD_ACTIONBUTTON_PROPERTIES_H_
