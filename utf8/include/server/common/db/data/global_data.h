 ...
 *      cn: 这个是全局数据的操作实现类，负责与数据库的存取数据，以后考虑将格式统一，自动生成代码
 */
#ifndef PAP_SERVER_COMMON_DB_DATA_GLOBAL_DATA_H_
#define PAP_SERVER_COMMON_DB_DATA_GLOBAL_DATA_H_
...
class GlobalData : public System {

 public:
   GlobalData(ODBCInterface* odbc_interface);
   ~GlobalData();
   virtual bool load();
...
#endif //PAP_SERVER_COMMON_DB_DATA_GLOBAL_DATA_H_
