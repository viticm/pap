...
//MAX = MIN + LENGTH + 2
/*billing login { */
#define BILLINGLOGIN_PACKETID_MIN 5 //前1--5为服务器直接公用的包
...
#define SERVERWORLD_PACKETID_MAX (SERVERWORLD_PACKETID_MIN + 58 + 2)
#define WORLD_TOSERVER_PACKETID_MIN (SERVERWORLD_PACKETID_MAX - 1)
