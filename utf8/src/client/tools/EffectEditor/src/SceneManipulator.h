...
public:
    ...
    */
	...
	void setLocatorVisible(bool visible);
	void _updateAxexInfo(Ogre::Vector3 pos, Ogre::Quaternion qRot);
	Ogre::SceneNode* getLocatorNode();
...
public:
	...
	Ogre::SceneNode* mAxisNode_x;
	Ogre::SceneNode* mAxisNode_y;
	Ogre::SceneNode* mAxisNode_z;
