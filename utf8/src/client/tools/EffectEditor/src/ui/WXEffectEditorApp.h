#ifndef __EFFECTEDITORAPP_H__
#define __EFFECTEDITORAPP_H__
...
class EffectEditorApp : public wxApp
{
public:
...
public:
    ...
    EffectEditorFrame* GetMainFrame(void) const
    {
        return mMainFrame;
    }
