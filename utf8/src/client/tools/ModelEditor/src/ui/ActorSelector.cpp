...
void ActorSelector::Reload(void)
{
    ...
    **/
    ...
    {
        Ogre::String templateName(modelIt.peekNextKey().c_str());

        wxTreeItemId item = AddLeaf(root, AS_STRING(templateName));
        mActorList->SetItemData(item, new ModelItemData(templateName, "", ""));
