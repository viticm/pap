...
namespace Fairy {
    ...
    /*!
    \brief
        namespace to give scope to scan code enumeration.
    */
    namespace Key
    {
    ...
    */
    enum SystemKey
    {
        Shift           = 0x01,         //!< Either shift key.
        Control         = 0x02,         //!< Either control key.
        Alt             = 0x04,         //!< Either alt key.
        Meta            = 0x08,         //!< Either meta key.
        LeftMouse       = 0x10,         //!< The left mouse button.
        RightMouse      = 0x20,         //!< The right mouse button.
        MiddleMouse     = 0x40,         //!< The middle mouse button.
        X1Mouse         = 0x80,         //!< The first 'extra' mouse button
        X2Mouse         = 0x100,        //!< The second 'extra' mouse button.

        KeyboardFlags   = Meta|Alt|Control|Shift,                           //!< all keyboard flags
        MouseFlags      = LeftMouse|RightMouse|MiddleMouse|X1Mouse|X2Mouse, //!< all mouse flags
    };
    ...
    struct MouseEvent : public Event
    {
        ...
        Real        wheelChange;    //!< Holds the amount the scroll wheel has changed.
    ...
    {
        uint        sysKeys;        //!< current state of the system keys and mouse buttons.
        uint        codepoint;      //!< codepoint for the key (only used for Character inputs).
