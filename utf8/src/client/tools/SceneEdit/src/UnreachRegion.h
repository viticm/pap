...
#include "core/FairyObjectFactory.h"
...
namespace Fairy 
{
	...
	public:
		...
		Fairy::ObjectPtr    pObjectPtr;
		Fairy::ObjectProxy* mProxy;
		///////////////////////////////////////////////////////////////////////////////
		//
		// 基本操作函数 
		//
	...
	public:
		...
		unsigned long		m_ulCurSelectPointId;   // 这个区域前一个选择点id.
		...
		Ogre::Vector3		m_vBasePoint;			//区域的基本位置参考点，用于选择区域时相机操作参考
		bool				 m_bHasBasePoint;		//标示是否设置基本位置参考点
	...
	public:
		...
		// 设置区域编辑状态材质
		void SetRegionEditMaterial();
		void SetRegionEditMaterial1();
