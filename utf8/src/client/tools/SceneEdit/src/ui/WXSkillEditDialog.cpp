...
FairySkillEditDialog::OnPropertyChanged(wxPropertyGridEvent& e)
{
	...
	// 更新模板
	Fairy::Skill *skill = Fairy::EffectManager::getSingleton().getSkill(mSkill->getSkillName());

	*skill = *mSkill;
}

void FairySkillEditDialog::InitSkillDialog( Fairy::LogicModel *object, Fairy::SceneManipulator *sceneManipulator )
{
...
void FairySkillEditDialog::InitPropertyEditor(void)
{
	...
	*skill = *mSkill;
	...
	{
		Fairy::AnimationEffectInfo *effectInfo = mSkill->getAnimationEffectInfo(i);
	...
	{
		Fairy::AnimationRibbon *ribbon = mSkill->getAnimationRibbon(i);
	...
	{
		Fairy::AnimationSound *sound = mSkill->getAnimationSound(i);
    ...
    {
        Fairy::AnimationSceneLightInfo *light = mSkill->getAnimationSceneLightInfo(i);
...
AddEffectInfoDialog::OnInitDialog(wxInitDialogEvent &e)
{
	...
	Fairy::LogicModel *object = static_cast<FairySkillEditDialog *>(this->GetParent())->mDObject;
	assert (object);
