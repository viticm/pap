...
FairySceneCanvas::OnKeyDown(wxKeyEvent& e)
{
	...
	case WXK_CONTROL:
		if ( mSceneManipulator && mSceneManipulator->getActiveAction())
		{
			...
			if ( actionName == "AutoTexPaintAction" ) //画刷按住CTRAL，将不会随即
			{
