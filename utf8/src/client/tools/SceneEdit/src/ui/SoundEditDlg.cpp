...
void SoundEditDialog::SetSceneManipulator(Fairy::SceneManipulator* manipulator)
{
...
void SoundEditDialog::onUIChanged(void* data, Fairy::UIChangeType type)
{
    if (type == Fairy::UIC_SOUNDEDIT)
    {
