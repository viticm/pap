...
wxSizer *EditRegionDlg( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxListCtrl *itemRegion = new wxListCtrl( parent, ID_LISTCTRL_LINE, wxDefaultPosition, wxSize(220,100), wxLC_REPORT|wxSUNKEN_BORDER|wxLC_SINGLE_SEL );
	item0->Add( itemRegion, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5 );
