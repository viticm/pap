...
public:
	...
	void InitSkillDialog( Fairy::LogicModel *object, Fairy::SceneManipulator *sceneManipulator );
...
protected:
	...
	void saveEffect(Fairy::Effect *effect, const Ogre::String &templateName, std::ofstream &of);*/
