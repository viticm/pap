...
void DatuPointEditDialog::SetSceneManipulator(Fairy::SceneManipulator* manipulator)
{
...
void DatuPointEditDialog::onUIChanged(void* data, Fairy::UIChangeType type)
{
    if (type == Fairy::UIC_DATUPOINTEDIT)
    {
...
bool DatuPointEditDialog::Show(bool show)
{
    if (mSceneManipulator)
    {
        Fairy::Action* action = mSceneManipulator->_getAction("DatuPointEditAction");
