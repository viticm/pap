...
protected:
    ...
    void addEffect(void);
    Fairy::Effect* getCurrentEffect(void);
...
protected:
    ...
    Fairy::LogicModel* mEquipModel;
    Fairy::LogicModel* mLeftHandWeapon;
    Fairy::LogicModel* mRightHandWeapon;
    Fairy::LogicModel* mCurrentWeapon;
    ...
    Fairy::LogicModel::EffectHandle mCurrentEffectHandle;
