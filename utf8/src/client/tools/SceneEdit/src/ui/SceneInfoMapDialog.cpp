...
void SceneInfoMapDialog::ImportHTimage()
{
	...
	{
		wxMessageBox(wxT("此高度图与场景地形高度图尺寸不符！请选择正确的高度图！"),
			wxT("高度图与场景地形高度图不符"),
	...
	HeightMapScopeSettingDialog dlg(this, wxID_ANY, _("设置高度图的最大值和最小值"));
...
DnDCanvasBitmap::OnPaint(wxPaintEvent& event)
{
    ...
    DrawNavigator(dc);  //导致死机BUG，暂时注释掉 laim
