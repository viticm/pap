...
public:
    ...
    */
	...
	virtual bool unsubscribeEvent(const String& name, Event::Subscriber subscriber);
    ...
    */
	...
	virtual bool unsubscribeEvent(const String& name, Event::Group group, Event::Subscriber subscriber);
