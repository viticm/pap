...
/*!
\brief
	String32 class used within the GUI system.

	For the most part, this class can replace std::string in basic usage.  However, currently String32 does not use the
	current locale, and also comparisons do not take into account the Unicode data tables, so are not 'correct'
	as such.
*/
class CEGUIEXPORT String32
{
public:
	/*************************************************************************
		Integral Types
	*************************************************************************/
	typedef		utf32			value_type;					//!< Basic 'code point' type used for String32 (utf32)
...
public:
	...
	*************************************************************************/
	/*!
	\brief
		Constant forward iterator class for String32 objects
	*/
...
#	pragma warning (pop)
	...
	/*!
	\brief
		Forward iterator class for String32 objects
	*/
...
#	pragma warning (pop)
	...
	/*!
	\brief
		Constant reverse iterator class for String32 objects
	*/
	...
	/*!
	\brief
		Reverse iterator class for String32 objects
	*/
#if defined(_MSC_VER) && ((_MSC_VER <= 1200) || ((_MSC_VER <= 1300) && defined(_STLPORT_VERSION)))
...
public:
    /*!
    \brief
        Functor that can be used as comparator in a std::map with String32 keys.
...
public:
	...
	*/
	...
	/*!
	\brief
		Destructor for String32 objects
	*/
	~String32(void);

	//////////////////////////////////////////////////////////////////////////
	// Construction via CEGUI::String32
	//////////////////////////////////////////////////////////////////////////
	/*!
	\brief
	...
	\param str
		String32 object used to initialise the newly created string

	\return
		Nothing
	*/
	String32(const String32& str)
	{
		init();
		assign(str);
	}
	...
	/*!
	\brief
		Constructs a new string initialised with code points from another String32 object.

	\param str
		String32 object used to initialise the newly created string

	\param str_idx
		Starting code-point of \a str to be used when initialising the new String32

	\param str_num
		Maximum number of code points from \a str that are to be assigned to the new String32

	\return
		Nothing
	*/
	String32(const String32& str, size_type str_idx, size_type str_num = npos)
	{
		init();
	...
	\param std_str
		The std::string object that is to be used to initialise the new String32 object.
	...
	\exception std::length_error	Thrown if resulting String32 object would be too big.
	*/
	String32(const std::string& std_str)
	{
		init();
		assign(std_str);
	}
	...
	\param str_idx
		Starting character of \a std_str to be used when initialising the new String32
	...
	\param str_num
		Maximum number of characters from \a std_str that are to be assigned to the new String32
	...
	\exception std::length_error	Thrown if resulting String32 object would be too big.
	*/
	String32(const std::string& std_str, size_type str_idx, size_type str_num = npos)
	{
		init();
	...
	/*!
	\brief
		Constructs a new String32 object and initialise it using the provided utf8 encoded string buffer.
	...
	\note
		...
		would result in incorrect behaviour as the String32 will attempt to 'decode' the data, with unpredictable
		results.
	...
	*/
	...
	\exception std::length_error	Thrown if resulting String32 object would be too big.
	*/
	String32(const utf8* utf8_str, size_type chars_len)
	{
		init();
	...
	/*!
	\brief
		Constructs a new String32 that is initialised with the specified code point

	\param num
		The number of times \a code_point is to be put into new String32 object

	\param code_point
		The Unicode code point to be used when initialising the String32 object
	...
	\exception std::length_error	Thrown if resulting String32 object would be too big.
	*/
	String32(size_type num, utf32 code_point)
	{
		init();
	...
	\param beg
		Iterator describing the start of the data to be used when initialising the String32 object

	\param end
		Iterator describing the (exclusive) end of the data to be used when initialising the String32 object

	\return 
		Nothing
	*/
	String32(const_iterator iter_beg, const_iterator iter_end)
	{
		init();
	...
	/*!
	\brief
		Constructs a new String32 object and initialise it using the provided c-string.
	...
	*/
	...
	/*!
	\brief
		Constructs a new String32 object and initialise it using characters from the provided char array.
	...
	\exception std::length_error	Thrown if resulting String32 object would be too big.
	*/
	String32(const char* chars, size_type chars_len)
	{
		init();
	...
	/*!
	\brief
		Returns the size of the String32 in code points

	\return
		Number of code points currently in the String32
	*/
	...
	*/
	...
	/*!
	\brief
		Returns true if the String32 is empty

	\return
		true if the String32 is empty, else false.
	*/
	...
	/*!
	\brief
		Returns the maximum size of a String32.

		Any operation that would result in a String32 that is larger than this value will throw the std::length_error exception.
	...
	*/
	...
	/*!
	\brief
		Return the number of code points that the String32 could hold before a re-allocation would be required.

	\return
		Size of the current reserve buffer.  This is the maximum number of code points the String32 could hold before a buffer
	...
	*/
	...
	\param num
		...
		String32 size (operation is currently not implemented).  If \a num is 0, then the buffer is re-allocated to fit the current String32 size.
	...
	*/
	...
	/*!
	\brief
		Compares this String32 with the String32 'str'.

	\note
		This does currently not properly consider Unicode and / or the system locale.

	\param str
		The String32 object that is to compared with this String32.

	\return
		-  0 if the String32 objects are equal
		- <0 if this String32 is lexicographically smaller than \a str
		- >0 if this String32 is lexicographically greater than \a str
	*/
	int		compare(const String32& str) const
	{
	...
	/*!
	\brief
		Compares code points from this String32 with code points from the String32 'str'.

	\note
		This does currently not properly consider Unicode and / or the system locale.

	\param idx
		Index of the first code point from this String32 to consider.

	\param len
		Maximum number of code points from this String32 to consider.

	\param str
		The String32 object that is to compared with this String32.

	\param str_idx
		Index of the first code point from String32 \a str to consider.

	\param str_len
		Maximum number of code points from String32 \a str to consider
	...
	*/
	int		compare(size_type idx, size_type len, const String32& str, size_type str_idx = 0, size_type str_len = npos) const
	{
		if ((d_cplength < idx) || (str.d_cplength < str_idx))
			throw std::out_of_range("Index is out of range for CEGUI::String32");
	...
	/*!
	\brief
		Compares this String32 with the std::string 'std_str'.

	\note
		This does currently not properly consider Unicode and / or the system locale.

	\param std_str
		The std::string object that is to compared with this String32.
	...
	*/
	...
	/*!
	\brief
		Compares code points from this String32 with code points from the std::string 'std_str'.
	...
	*/
	...
	/*!
	\brief
		Compares this String32 with the null-terminated utf8 encoded 'utf8_str'.

	\note
		This does currently not properly consider Unicode and / or the system locale.

	\param utf8_str
		The buffer containing valid Unicode data encoded as utf8 that is to compared with this String32.
	...
	*/
	...
	/*!
	\brief
		Compares code points from this String32 with the null-terminated utf8 encoded 'utf8_str'.
	...
	*/
	...
	/*!
	\brief
		Compares code points from this String32 with the utf8 encoded data in buffer 'utf8_str'.
	...
	*/
	...
	/*!
	\brief
		Compares this String32 with the given c-string.

	\note
		This does currently not properly consider Unicode and / or the system locale.

	\param c_str
		The c-string that is to compared with this String32.
	...
	*/
	...
	/*!
	\brief
		Compares code points from this String32 with the given c-string.
	...
	*/
	...
	/*!
	\brief
		Compares code points from this String32 with chars in the given char array.
	...
	\param chars
		The array containing the chars that are to compared with this String32.
	...
	*/
	...
	\return
		The utf32 code point at the given index within the String32.
	*/
	...
	*/
	...
	/*!
	\brief
		Returns contents of the String32 as a null terminated string of utf8 encoded data.

	\return
		Pointer to a char buffer containing the contents of the String32 encoded as null-terminated utf8 data.

	\note
		The buffer returned from this function is owned by the String32 object.

	\note
		Any function that modifies the String32 data will invalidate the buffer returned by this call.
	*/
	...
	/*!
	\brief
		Returns contents of the String32 as utf8 encoded data.

	\return
		Pointer to a buffer containing the contents of the String32 encoded utf8 data.
	...
	*/
	...
	/*!
	\brief
		Copies an area of the String32 into the provided buffer as encoded utf8 data.

	\param buf
		Pointer to a buffer that is to receive the encoded data (this must be big enough to hold the encoded data)

	\param len
		Maximum number of code points from the String32 that should be encoded into the buffer
	...
	\exception std::out_of_range	Thrown if \a idx was invalid for this String32.
	*/
	...
	/*!
	\brief
		Return the number of utf8 code units required to hold an area of the String32 when encoded as utf8 data
	...
	*/
	size_type	utf8_stream_len(size_type num = npos, size_type idx = 0) const
	{
		...
		if (d_cplength < idx)
			throw out_of_range("Index was out of range for CEGUI::String32 object");
	...
	/*!
	\brief
		Assign the value of String32 \a str to this String32

	\param str
		String32 object containing the string value to be assigned.

	\return
		This String32 after the assignment has happened
	*/
	String32&	operator=(const String32& str)
	{
		return assign(str);
	}
	...
	/*!
	\brief
		Assign a sub-string of String32 \a str to this String32

	\param str
		String32 object containing the string data to be assigned.
	...
	*/
	String32&	assign(const String32& str, size_type str_idx = 0, size_type str_num = npos)
	{
		if (str.d_cplength < str_idx)
			throw std::out_of_range("Index was out of range for CEGUI::String32 object");
	...
	/*!
	\brief
		Assign the value of std::string \a std_str to this String32
	...
	\exception std::length_error	Thrown if the resulting String32 would have been too large.
	*/
	String32&	operator=(const std::string& std_str)
	{
	...
	/*!
	\brief
		Assign a sub-string of std::string \a std_str to this String32
	...
	\exception std::length_error	Thrown if the resulting String32 would have been too large.
	*/
	String32&	assign(const std::string& std_str, size_type str_idx = 0, size_type str_num = npos)
	{
		if (std_str.size() < str_idx)
	...
	/*!
	\brief
		Assign to this String32 the string value represented by the given null-terminated utf8 encoded data
	...
	\exception std::length_error	Thrown if the resulting String32 would have been too large.
	*/
	String32&	operator=(const utf8* utf8_str)
	{
	...
	\exception std::length_error	Thrown if the resulting String32 would have been too large.
	*/
	String32&	assign(const utf8* utf8_str)
	{
		return assign(utf8_str, utf_length(utf8_str));
	}
	...
	/*!
	\brief
		Assign to this String32 the string value represented by the given utf8 encoded data
	...
	\exception std::length_error	Thrown if the resulting String32 would have been too large, or if str_num is 'npos'.
	*/
	String32&	assign(const utf8* utf8_str, size_type str_num)
	{
		if (str_num == npos)
			throw std::length_error("Length for utf8 encoded string can not be 'npos'");
	...
	/*!
	\brief
		Assigns the specified utf32 code point to this String32.  Result is always a String32 1 code point in length.

	\param code_point
		Valid utf32 Unicode code point to be assigned to the string

	\return
		This String32 after assignment
	*/
	String32&	operator=(utf32 code_point)
	{
	...
	/*!
	\brief
		Assigns the specified code point repeatedly to the String32
	...
	*/
	String32&	assign(size_type num, utf32 code_point)
	{
		if (num == npos)
	...
	/*!
	\brief
		Assign to this String32 the given C-string.
	...
	\exception std::length_error	Thrown if the resulting String32 would have been too large.
	*/
	String32&	operator=(const char* cstr)
	{
	...
	\exception std::length_error	Thrown if the resulting String32 would have been too large.
	*/
	String32&	assign(const char* cstr)
	{
		return assign(cstr, strlen(cstr));
	}
	...
	/*!
	\brief
		Assign to this String32 a number of chars from a char array.
	...
	\exception std::length_error	Thrown if the resulting String32 would have been too large.
	*/
	String32&	assign(const char* chars, size_type chars_len)
	{
		grow(chars_len);
		utf32* pt = ptr();
	...
	/*!
	\brief
		Swaps the value of this String32 with the given String32 \a str

	\param str
		String32 object whos value is to be swapped with this String32.

	\return
		Nothing
	*/
	void	swap(String32& str)
	{
	...
	/*!
	\brief
		Appends the String32 \a str

	\param str
		String32 object that is to be appended

	\return
		This String32 after the append operation

	\exception std::length_error	Thrown if resulting String32 would be too large.
	*/
	String32&	operator+=(const String32& str)
	{
		return append(str);
	...
	/*!
	\brief
		Appends a sub-string of the String32 \a str

	\param str
		String32 object containing data to be appended
	...
	\exception std::length_error	Thrown if resulting String32 would be too large.
	*/
	String32& append(const String32& str, size_type str_idx = 0, size_type str_num = npos)
	{
		if (str.d_cplength < str_idx)
			throw std::out_of_range("Index is out of range for CEGUI::String32");
	...
	*/
	...
	\exception std::length_error	Thrown if resulting String32 would be too large.
	*/
	String32& append(const std::string& std_str, size_type str_idx = 0, size_type str_num = npos)
	{
		if (std_str.size() < str_idx)
			throw std::out_of_range("Index is out of range for std::string");
	...
	/*!
	\brief
		Appends to the String32 the null-terminated utf8 encoded data in the buffer utf8_str.
	...
	*/
	...
	\exception std::length_error	Thrown if resulting String32 would be too large.
	*/
	String32& append(const utf8* utf8_str)
	{
		return append(utf8_str, utf_length(utf8_str));
	}
	...
	/*!
	\brief
		Appends to the String32 the utf8 encoded data in the buffer utf8_str.
	...
	\exception std::length_error	Thrown if resulting String32 would be too large, or if \a len was 'npos'
	*/
	String32& append(const utf8* utf8_str, size_type len)
	{
		if (len == npos)
			throw std::length_error("Length for utf8 encoded string can not be 'npos'");
	...
	\exception std::length_error	Thrown if resulting String32 would be too long.
	*/
	String32& operator+=(utf32 code_point)
	{
	...
	\exception std::length_error	Thrown if resulting String32 would be too long, or if \a num was 'npos'.
	*/
	String32& append(size_type num, utf32 code_point)
	{
		if (num == npos)
			throw std::length_error("Code point count can not be 'npos'");
	...
	*/
	String32&	append(const_iterator iter_beg, const_iterator iter_end)
	{
	...
	/*!
	\brief
		Appends to the String32 the given c-string.
	...
	*/
	...
	\exception std::length_error	Thrown if resulting String32 would be too large.
	*/
	String32& append(const char* cstr)
	{
		return append(cstr, strlen(cstr));
	}
	...
	/*!
	\brief
		Appends to the String32 chars from the given char array.
	...
	\exception std::length_error	Thrown if resulting String32 would be too large, or if \a chars_len was 'npos'
	*/
	String32& append(const char* chars, size_type chars_len)
	{
		if (chars_len == npos)
			throw std::length_error("Length for char array can not be 'npos'");
	...
	/*!
	\brief
		Inserts the given String32 object at the specified position.

	\param idx
		Index where the string is to be inserted.

	\param str
		String32 object that is to be inserted.

	\return
		This String32 after the insert.

	\exception std::out_of_range	Thrown if \a idx is invalid for this String32.
	\exception std::length_error	Thrown if resulting String32 would be too large.
	*/
	String32&	insert(size_type idx, const String32& str)
	{
	...
	/*!
	\brief
		Inserts a sub-string of the given String32 object at the specified position.

	\param idx
		Index where the string is to be inserted.

	\param str
		String32 object containing data to be inserted.
	...
	\exception std::length_error	Thrown if resulting String32 would be too large.
	*/
	String32& insert(size_type idx, const String32& str, size_type str_idx, size_type str_num)
	{
		if ((d_cplength < idx) || (str.d_cplength < str_idx))
			throw std::out_of_range("Index is out of range for CEGUI::String32");
	...
	\exception std::length_error	Thrown if resulting String32 would be too large.
	*/
	String32&	insert(size_type idx, const std::string& std_str)
	{
	...
	\exception std::length_error	Thrown if resulting String32 would be too large.
	*/
	String32& insert(size_type idx, const std::string& std_str, size_type str_idx, size_type str_num)
	{
		if (d_cplength < idx)
			throw std::out_of_range("Index is out of range for CEGUI::String32");
	...
	\exception std::length_error	Thrown if resulting String32 would be too large.
	*/
	String32&	insert(size_type idx, const utf8* utf8_str)
	{
	...
	\exception std::out_of_range	Thrown if \a idx is invalid for this String32.
	\exception std::length_error	Thrown if resulting String32 would be too large, or if \a len is 'npos'
	*/
	String32& insert(size_type idx, const utf8* utf8_str, size_type len)
	{
		if (d_cplength < idx)
			throw std::out_of_range("Index is out of range for CEGUI::String32");
	...
	/*!
	\brief
		Inserts a code point multiple times into the String32
	...
	\return
		This String32 after the insertion.

	\exception std::out_of_range	Thrown if \a idx is invalid for this String32.
	\exception std::length_error	Thrown if resulting String32 would be too large, or if \a num is 'npos'
	*/
	String32& insert(size_type idx, size_type num, utf32 code_point)
	{
		if (d_cplength < idx)
			throw std::out_of_range("Index is out of range for CEGUI::String32");
	...
	*/
	...
	/*!
	\brief
		Inserts a single code point into the String32
	...
	*/
	...
	\exception std::length_error	Thrown if resulting String32 would be too large.
	*/
	String32&	insert(size_type idx, const char* cstr)
	{
	...
	\exception std::out_of_range	Thrown if \a idx is invalid for this String32.
	\exception std::length_error	Thrown if resulting String32 would be too large, or if \a chars_len is 'npos'
	*/
	String32& insert(size_type idx, const char* chars, size_type chars_len)
	{
		if (d_cplength < idx)
			throw std::out_of_range("Index is out of range for CEGUI::String32");
	...
	/*!
	\brief
		Removes all data from the String32
	...
	*/
	...
	\return
		This String32 after the erase operation

	\exception std::out_of_range	Thrown if \a idx is invalid for this String32.
	*/
	String32&	erase(size_type idx)
	{
		return erase(idx, 1);
	}
	...
	\exception std::out_of_range	Thrown if \a idx is invalid for this String32.
	*/
	String32& erase(size_type idx, size_type len = npos)
	{
		if (d_cplength < idx)
			throw std::out_of_range("Index is out of range foe CEGUI::String32");
	...
	*/
	...
	\return
		This String32 after the erase operation.
	*/
	String32& erase(iterator iter_beg, iterator iter_end)
	{
	...
	/*!
	\brief
		Resizes the String32 either by inserting default utf32 code points to make it larger, or by truncating to make it smaller

	\param num
		The length, in code points, that the String32 is to be made.

	\return
		Nothing.

	\exception std::length_error	Thrown if the String32 would be too large.
	*/
	...
	size_type mbcs_length(void) const
	{
		...
		size_type ret = 0;
		while(code < code_dead_end && code!=0 && *code!=0)
		{
			if(	*code >= 0x20 &&	//' '
				*code <= 0x7f)		//'~'
			{
			...
			else if( *code == 0x0a)	//'\n' change line flag. used in multiline editbox. by yangjun [6/8/2006]
			{
				ret++;
				code++;
			}
	...
	/*!
	\brief
		Resizes the String32 either by inserting the given utf32 code point to make it larger, or by truncating to make it smaller

	\param num
		The length, in code points, that the String32 is to be made.

	\param code_point
		The utf32 code point that should be used when majing the String32 larger
	...
	*/
	...
	/*!
	\brief
		Replace code points in the String32 with the specified String32 object
	...
	\param str
		The String32 object that is to replace the specified code points

	\return
		This String32 after the replace operation

	\exception std::out_of_range	Thrown if \a idx is invalid for this String32
	\exception std::length_error	Thrown if the resulting String32 would be too large.
	*/
	String32& replace(size_type idx, size_type len, const String32& str)
	{
	...
	/*!
	\brief
		Replace the code points in the range [beg, end) with the specified String32 object
	...
	\param str
		The String32 object that is to replace the specified range of code points
	...
	\exception std::length_error	Thrown if the resulting String32 would be too large.
	*/
	String32& replace(iterator iter_beg, iterator iter_end, const String32& str)
	{
	...
	/*!
	\brief
		Replace code points in the String32 with a specified sub-string of a given String32 object.
	...
	\param str
		String32 object containing the data that will replace the specified range of code points
	...
	\exception std::length_error	Thrown if the resulting String32 would have been too large.
	*/
	String32& replace(size_type idx, size_type len, const String32& str, size_type str_idx, size_type str_num)
	{
		if ((d_cplength < idx) || (str.d_cplength < str_idx))
			throw std::out_of_range("Index is out of range for CEGUI::String32");
	...
	/*!
	\brief
		Replace code points in the String32 with the specified std::string object
	...
	\exception std::length_error	Thrown if the resulting String32 would be too large.
	*/
	String32& replace(size_type idx, size_type len, const std::string& std_str)
	{
	...
	\exception std::length_error	Thrown if the resulting String32 would be too large.
	*/
	String32& replace(iterator iter_beg, iterator iter_end, const std::string& std_str)
	{
	...
	/*!
	\brief
		Replace code points in the String32 with a specified sub-string of a given std::string object.
	...
	\exception std::length_error	Thrown if the resulting String32 would have been too large.
	*/
	String32& replace(size_type idx, size_type len, const std::string& std_str, size_type str_idx, size_type str_num)
	{
		if (d_cplength < idx)
			throw std::out_of_range("Index is out of range for CEGUI::String32");
	...
	/*!
	\brief
		Replace code points in the String32 with the specified null-terminated utf8 encoded data.
	...
	\exception std::length_error	Thrown if the resulting String32 would be too large.
	*/
	String32& replace(size_type idx, size_type len, const utf8* utf8_str)
	{
	...
	\exception std::length_error	Thrown if the resulting String32 would be too large.
	*/
	String32& replace(iterator iter_beg, iterator iter_end, const utf8* utf8_str)
	{
	...
	/*!
	\brief
		Replace code points in the String32 with the specified utf8 encoded data.
	...
	\exception std::out_of_range	Thrown if \a idx is invalid for this String32
	\exception std::length_error	Thrown if the resulting String32 would be too large, or if \a str_len was 'npos'.
	*/
	String32& replace(size_type idx, size_type len, const utf8* utf8_str, size_type str_len)
	{
		if (d_cplength < idx)
			throw std::out_of_range("Index is out of range for CEGUI::String32");
	...
	\return
		...
		\exception std::length_error	Thrown if the resulting String32 would be too large, or if \a str_len was 'npos'.
	*/
	String32& replace(iterator iter_beg, iterator iter_end, const utf8* utf8_str, size_type str_len)
	{
	...
	\exception std::out_of_range	Thrown if \a idx is invalid for this String32
	\exception std::length_error	Thrown if resulting String32 would have been too long, or if \a num was 'npos'.
	*/
	String32& replace(size_type idx, size_type len, size_type num, utf32 code_point)
	{
		if (d_cplength < idx)
			throw std::out_of_range("Index is out of range for CEGUI::String32");
	...
	\exception std::length_error	Thrown if resulting String32 would have been too long, or if \a num was 'npos'.
	*/
	String32& replace(iterator iter_beg, iterator iter_end, size_type num, utf32 code_point)
	{
	...
	\return
		This String32 after the insert operation.

	\exception std::length_error	Thrown if the resulting string would be too long.
	*/
	String32& replace(iterator iter_beg, iterator iter_end, const_iterator iter_newBeg, const_iterator iter_newEnd)
	{
	...
	/*!
	\brief
		Replace code points in the String32 with the specified c-string.
	...
	\exception std::length_error	Thrown if the resulting String32 would be too large.
	*/
	String32& replace(size_type idx, size_type len, const char* cstr)
	{
	...
	\exception std::length_error	Thrown if the resulting String32 would be too large.
	*/
	String32& replace(iterator iter_beg, iterator iter_end, const char* cstr)
	{
	...
	/*!
	\brief
		Replace code points in the String32 with chars from the given char array.
	...
	\exception std::out_of_range	Thrown if \a idx is invalid for this String32
	\exception std::length_error	Thrown if the resulting String32 would be too large, or if \a chars_len was 'npos'.
	*/
	String32& replace(size_type idx, size_type len, const char* chars, size_type chars_len)
	{
		if (d_cplength < idx)
			throw std::out_of_range("Index is out of range for CEGUI::String32");
	...
	\exception std::length_error	Thrown if the resulting String32 would be too large, or if \a chars_len was 'npos'.
	*/
	String32& replace(iterator iter_beg, iterator iter_end, const char* chars, size_type chars_len)
	{
	...
	*/
	...
	\param str
		String32 object describing the sub-string to search for
	...
	*/
	size_type	find(const String32& str, size_type idx = 0) const
	{
	...
	\return
		...
		- npos if the sub-string could not be found
	*/
	size_type	rfind(const String32& str, size_type idx = npos) const
	{
		if (str.d_cplength == 0)
	...
	*/
	...
	\param str
		String32 object describing the set of code points.
	...
	*/
	size_type	find_first_of(const String32& str, size_type idx = 0) const
	{
		if (idx < d_cplength)
		{
			const utf32* pt = &ptr()[idx];
	...
	*/
	size_type	find_first_not_of(const String32& str, size_type idx = 0) const
	{
		if (idx < d_cplength)
		{
			const utf32* pt = &ptr()[idx];
	...
	*/
	...
	\return
		...
		- npos if none of the code points in \a str were found.
	*/
	size_type	find_last_of(const String32& str, size_type idx = npos) const
	{
		if (d_cplength > 0)
		{
			if (idx >= d_cplength)
	...
	\return
		...
		- npos if all code points matched one of the code points in \a str.
	*/
	size_type	find_last_not_of(const String32& str, size_type idx = npos) const
	{
		if (d_cplength > 0)
		{
			if (idx >= d_cplength)
	...
	*/
	...
	/*!
	\brief
		Returns a substring of this String32.
	...
	\return
		A String32 object containing the specified sub-string.

	\exception std::out_of_range	Thrown if \a idx is invalid for this String32.
	*/
	String32	substr(size_type idx = 0, size_type len = npos) const
	{
		if (d_cplength < idx)
			throw std::out_of_range("Index is out of range for this CEGUI::String32");

		return String32(*this, idx, len);
	}
	...
	/*!
	\brief
		Return a forwards iterator that describes the beginning of the String32

	\return
		iterator object that describes the beginning of the String32.
	*/
	iterator		begin(void)
	{
		return iterator(ptr());
	...
	/*!
	\brief
		Return a constant forwards iterator that describes the beginning of the String32

	\return
		const_iterator object that describes the beginning of the String32.
	*/
	...
	/*!
	\brief
		Return a forwards iterator that describes the end of the String32

	\return
		iterator object that describes the end of the String32.
	*/
	iterator		end(void)
	{
	...
	/*!
	\brief
		Return a constant forwards iterator that describes the end of the String32

	\return
		const_iterator object that describes the end of the String32.
	*/
	...
	/*!
	\brief
		Return a reverse iterator that describes the beginning of the String32

	\return
		reverse_iterator object that describes the beginning of the String32 (so is actually at the end)
	*/
	...
	/*!
	\brief
		Return a constant reverse iterator that describes the beginning of the String32

	\return
		const_reverse_iterator object that describes the beginning of the String32 (so is actually at the end)
	*/
	...
	/*!
	\brief
		Return a reverse iterator that describes the end of the String32

	\return
		reverse_iterator object that describes the end of the String32 (so is actually at the beginning)
	*/
	...
	/*!
	\brief
		Return a constant reverse iterator that describes the end of the String32

	\return
		const_reverse_iterator object that describes the end of the String32 (so is actually at the beginning)
	*/
...
private:
	...
	*************************************************************************/
	...
	size_type encoded_size(const utf8* buf, size_type ulen) const
	{
		utf8 tcp;
		size_type count = 0;
		int len = ulen;
...
/*!
\brief
	Return true if String32 \a str1 is equal to String32 \a str2
*/
bool CEGUIEXPORT	operator==(const String32& str1, const String32& str2);

/*!
\brief
	Return true if String32 \a str is equal to std::string \a std_str
*/
bool CEGUIEXPORT	operator==(const String32& str, const std::string& std_str);

/*!
\brief
	Return true if String32 \a str is equal to std::string \a std_str
*/
bool CEGUIEXPORT	operator==(const std::string& std_str, const String32& str);

/*!
\brief
	Return true if String32 \a str is equal to null-terminated utf8 data \a utf8_str
*/
bool CEGUIEXPORT	operator==(const String32& str, const utf8* utf8_str);

/*!
\brief
	Return true if String32 \a str is equal to null-terminated utf8 data \a utf8_str
*/
bool CEGUIEXPORT	operator==(const utf8* utf8_str, const String32& str);

/*!
\brief
	Return true if String32 \a str1 is not equal to String32 \a str2
*/
bool CEGUIEXPORT	operator!=(const String32& str1, const String32& str2);

/*!
\brief
	Return true if String32 \a str is not equal to std::string \a std_str
*/
bool CEGUIEXPORT	operator!=(const String32& str, const std::string& std_str);
...
/*!
\brief
	Return true if String32 \a str is not equal to null-terminated utf8 data \a utf8_str
*/
bool CEGUIEXPORT	operator!=(const String32& str, const utf8* utf8_str);
...
/*!
\brief
	Return true if String32 \a str1 is lexicographically less than String32 \a str2
*/
bool CEGUIEXPORT	operator<(const String32& str1, const String32& str2);

/*!
\brief
	Return true if String32 \a str is lexicographically less than null-terminated utf8 data \a utf8_str
*/
bool CEGUIEXPORT	operator<(const String32& str, const utf8* utf8_str);
...
/*!
\brief
	Return true if String32 \a str1 is lexicographically greater than String32 \a str2
*/
bool CEGUIEXPORT	operator>(const String32& str1, const String32& str2);

/*!
\brief
	Return true if String32 \a str is lexicographically greater than null-terminated utf8 data \a utf8_str
*/
bool CEGUIEXPORT	operator>(const String32& str, const utf8* utf8_str);
...
/*!
\brief
	Return true if String32 \a str1 is lexicographically less than or equal to String32 \a str2
*/
bool CEGUIEXPORT	operator<=(const String32& str1, const String32& str2);

/*!
\brief
	Return true if String32 \a str is lexicographically less than or equal to std::string \a std_str
*/
bool CEGUIEXPORT	operator<=(const String32& str, const std::string& std_str);
...
/*!
\brief
	Return true if String32 \a str is lexicographically less than or equal to null-terminated utf8 data \a utf8_str
*/
bool CEGUIEXPORT	operator<=(const String32& str, const utf8* utf8_str);
...
/*!
\brief
	Return true if String32 \a str1 is lexicographically greater than or equal to String32 \a str2
*/
bool CEGUIEXPORT	operator>=(const String32& str1, const String32& str2);

/*!
\brief
	Return true if String32 \a str is lexicographically greater than or equal to std::string \a std_str
*/
bool CEGUIEXPORT	operator>=(const String32& str, const std::string& std_str);
...
/*!
\brief
	Return true if String32 \a str is lexicographically greater than or equal to null-terminated utf8 data \a utf8_str
*/
bool CEGUIEXPORT	operator>=(const String32& str, const utf8* utf8_str);
...
/*!
\brief
	Return true if String32 \a str is equal to c-string \a c_str
*/
bool CEGUIEXPORT	operator==(const String32& str, const char* c_str);

/*!
\brief
	Return true if c-string \a c_str is equal to String32 \a str
*/
bool CEGUIEXPORT	operator==(const char* c_str, const String32& str);

/*!
\brief
	Return true if String32 \a str is not equal to c-string \a c_str
*/
bool CEGUIEXPORT	operator!=(const String32& str, const char* c_str);

/*!
\brief
	Return true if c-string \a c_str is not equal to String32 \a str
*/
bool CEGUIEXPORT	operator!=(const char* c_str, const String32& str);

/*!
\brief
	Return true if String32 \a str is lexicographically less than c-string \a c_str
*/
bool CEGUIEXPORT	operator<(const String32& str, const char* c_str);

/*!
\brief
	Return true if c-string \a c_str is lexicographically less than String32 \a str
*/
bool CEGUIEXPORT	operator<(const char* c_str, const String32& str);

/*!
\brief
Return true if String32 \a str is lexicographically greater than c-string \a c_str
*/
bool CEGUIEXPORT	operator>(const String32& str, const char* c_str);

/*!
\brief
Return true if c-string \a c_str is lexicographically greater than String32 \a str
*/
bool CEGUIEXPORT	operator>(const char* c_str, const String32& str);

/*!
\brief
	Return true if String32 \a str is lexicographically less than or equal to c-string \a c_str
*/
bool CEGUIEXPORT	operator<=(const String32& str, const char* c_str);

/*!
\brief
	Return true if c-string \a c_str is lexicographically less than or equal to String32 \a str
*/
bool CEGUIEXPORT	operator<=(const char* c_str, const String32& str);

/*!
\brief
	Return true if String32 \a str is lexicographically greater than or equal to c-string \a c_str
*/
bool CEGUIEXPORT	operator>=(const String32& str, const char* c_str);

/*!
\brief
	Return true if c-string \a c_str is lexicographically greater than or equal to String32 \a str
*/
bool CEGUIEXPORT	operator>=(const char* c_str, const String32& str);
...
/*!
\brief
	Return String32 object that is the concatenation of the given inputs

\param str1
	String32 object describing first part of the new string

\param str2
	String32 object describing the second part of the new string

\return
	A String32 object that is the concatenation of \a str1 and \a str2

\exception std::length_error	Thrown if the resulting String32 would be too large.
*/
String32 CEGUIEXPORT	operator+(const String32& str1, const String32& str2);
...
\return
	A String32 object that is the concatenation of \a str and \a std_str

\exception std::length_error	Thrown if the resulting String32 would be too large.
*/
String32 CEGUIEXPORT	operator+(const String32& str, const std::string& std_str);
...
\return
	A String32 object that is the concatenation of \a std_str and \a str

\exception std::length_error	Thrown if the resulting String32 would be too large.
*/
String32 CEGUIEXPORT	operator+(const std::string& std_str, const String32& str);
...
\return
	A String32 object that is the concatenation of \a str and \a utf8_str

\exception std::length_error	Thrown if the resulting String32 would be too large.
*/
String32 CEGUIEXPORT	operator+(const String32& str, const utf8* utf8_str);
...
\exception std::length_error	Thrown if the resulting String32 would be too large.
*/
String32 CEGUIEXPORT	operator+(const utf8* utf8_str, const String32& str);
...
\param str
	String32 object describing the first part of the new string

\param code_point
	utf32 code point describing the second part of the new string

\return
	A String32 object that is the concatenation of \a str and \a code_point

\exception std::length_error	Thrown if the resulting String32 would be too large.
*/
String32 CEGUIEXPORT	operator+(const String32& str, utf32 code_point);
...
\return
	A String32 object that is the concatenation of \a code_point and \a str

\exception std::length_error	Thrown if the resulting String32 would be too large.
*/
String32 CEGUIEXPORT	operator+(utf32 code_point, const String32& str);
...
\return
	A String32 object that is the concatenation of \a str and \a c_str

\exception std::length_error	Thrown if the resulting String32 would be too large.
*/
String32 CEGUIEXPORT	operator+(const String32& str, const char* c_str);
...
\return
	A String32 object that is the concatenation of \a c_str and \a str

\exception std::length_error	Thrown if the resulting String32 would be too large.
*/
String32 CEGUIEXPORT	operator+(const char* c_str, const String32& str);


//////////////////////////////////////////////////////////////////////////
// Output (stream) functions
//////////////////////////////////////////////////////////////////////////
CEGUIEXPORT std::ostream& operator<<(std::ostream& s, const String32& str);
...
/*!
\brief
	Swap the contents for two String32 objects

\param str1
	String32 object who's contents are to be swapped with \a str2

\param str2
	String32 object who's contents are to be swapped with \a str1

\return
	Nothing
*/
void CEGUIEXPORT swap(String32& str1, String32& str2);
...
class CEGUIEXPORT String : public std::string
{
public:
	String(void) {}
	String(const std::string str)	: std::string(str) {}
	String(const String& str)		: std::string(str) {}
	String(const utf8* utf8_str)	: std::string((const char*)utf8_str) {}
