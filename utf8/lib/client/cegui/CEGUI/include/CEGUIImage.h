	...
	*/
	...
	public:
		...
		*/
		...
		The id of render quad in render queue
		*/
		unsigned long	draw(const Vector3& position, const Size& size, const Rect& clip_rect, const ColourRect& colours, QuadSplitMode quad_split_mode = TopLeftToBottomRight, bool need_quad_id = false) const
		{
		...
		The id of render quad in render queue
		*/
		unsigned long	draw(const Vector3& position, const Rect& clip_rect, const ColourRect& colours, QuadSplitMode quad_split_mode = TopLeftToBottomRight, bool need_quad_id = false) const
		{
		...
		The id of render quad in render queue
		*/
		unsigned long	draw(const Vector3& position, const Rect& clip_rect, const colour& top_left_colour = 0xFFFFFFFF, const colour& top_right_colour = 0xFFFFFFFF, const colour& bottom_left_colour = 0xFFFFFFFF, const colour& bottom_right_colour = 0xFFFFFFFF, QuadSplitMode quad_split_mode = TopLeftToBottomRight, bool need_quad_id = false) const
		{
		...
		The id of render quad in render queue
		*/
		unsigned long	draw(const Rect& dest_rect, float z, const Rect& clip_rect,const ColourRect& colours, QuadSplitMode quad_split_mode = TopLeftToBottomRight, bool need_quad_id = false) const;
