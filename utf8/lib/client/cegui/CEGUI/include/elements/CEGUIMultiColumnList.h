...
public:
	...
	*/
	...
	\return
		Nothing.
	*/
	void	addColumn(const String32& text, uint col_id, float width);
	...
	\return
		Nothing.
	*/
	void	insertColumn(const String32& text, uint col_id, float width, uint position);
...
protected:
	...
	*/
    ...
    int writePropertiesXML(OutStream& out_stream, const String& gap) const;
