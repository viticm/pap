...
public:
	...
	*/
	...
	\return
		Nothing.
	*/
	void	addColumn(const String32& text, uint id, float width);
	...
	\return
		Nothing.
	*/
	void	insertColumn(const String32& text, uint id, float width, uint position);
	...
	*/
	void	insertColumn(const String32& text, uint id, float width, const ListHeaderSegment& position);
...
protected:
	...
	*/
	ListHeaderSegment*	createInitialisedSegment(const String32& text, uint id, float width);
