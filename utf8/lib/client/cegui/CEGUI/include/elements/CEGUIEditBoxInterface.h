	...
	*/
	...
	public:
		...
		*/
		...
		/*!
		\brief
		Get the d_text's pixel rect of 0 -> caratPos.

		\param
		Nothing.
		\return
		Rect contain the new pos for ime use to set composition window.
		*/
		virtual Rect	getCaratTextExtent(void) const = 0;

		/** Is this editbox disable Ctrl+C and Ctrl+V
		*/
		virtual bool	getCopyPasteDisable(void) const = 0;
	};
