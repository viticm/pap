...
public:
	...
	*/
	ListboxItem(const String32& text, uint item_id = 0, void* item_data = NULL, bool disabled = false, bool auto_delete = true);
	...
	*/
	const String32&	getText(void) const		{return d_itemText;}
	const String32&	getTooltipText(void) const		{return d_tooltipText;}

	// 支持Listbox键盘快捷键选中ListboxItem
	const String32&	getTagText(void) const		{return d_tagText;}
	...
	*************************************************************************/
	...
	\return
		Nothing.
	*/
	void	setText(const String32& text)		{d_itemText = text;}

	void	setTooltipText(const String32& text)		{d_tooltipText = text;}
...
protected:
	...
	*/
	...
	/*************************************************************************
		Implementation Data
	*************************************************************************/
	String32	d_itemText;		//!< Text for this list box item.  If not rendered, this is still used for list sorting.
	String32  d_tooltipText;  //!< Text for the individual tooltip of this item
	...
	String32			d_tagText;			//!< 支持Listbox键盘快捷键选中ListboxItem
};
