...
namespace CEGUI
{
	...
	*/
	...
	protected:
		...
		*/
		size_t	getNextTokenLength(const String32& text, size_t start_idx) const;
		...
		*/
		...
		void	remove_FireFox_Utf32_Code(const String32& strIn, String32& strOut) const;
		bool	is_FireFox_Utf32_Code(const utf32& code) const;
