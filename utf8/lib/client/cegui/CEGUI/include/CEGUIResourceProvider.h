	...
	*/
	...
	public:
		...
		*/
		...
		virtual void loadRawDataContainer2(const String& filename, RawDataContainer& output, const String& resourceGroup) = 0;
		...
		*/
		...
		virtual DataStream* openDataStream(const String& filename, const String& resourceGroup) = 0;

		virtual void closeDataStream(DataStream* dataStream) = 0;
