...
public:
	...
	*/
	...
	void  setName(const utf8* szName);
	...
	*/
	...
	bool	isAutoWindow(void) const { return d_isAutoWindow; }
	void	setAutoWindow(bool setting) { d_isAutoWindow = setting; }
	...
	*/
	const String32&	getTextOriginal(void) const		{return d_textOriginal;}
	const String32&	getText(void) const		{return d_text;}
    ...
    */
     ...
     */
    const String32& getTooltipText(void) const;
	...
	*/
	...
	\return
		Nothing
	*/
	void	setTextOriginal(const String32& text);
	virtual void	setText(const String32& text);
    ...
    */
    ...
    \return
        Nothing.
    */
    void setTooltipText(const String32& tip);
	...
	*/
    ...
    \return
        Nothing.
    */
    virtual void writeXMLToStream(OutStream& out_stream, const String& gap) const;
	virtual int writePropertiesXML(OutStream& out_stream, const String& gap) const;
...
protected:
	...
	*/
	...
	/*!
	\brief
	Called when all child window drawed.
	*/
...
protected:
	...
	String32		d_textOriginal;		//!< Orininal text
	String32		d_text;				//!< Holds the text / label / caption for this Window.
	...
	// 保存区域
    Rect*			d_oldArea;          //!< This Window objects area as defined by a URect.
	...
	bool	d_isAutoWindow;		//!< whether is auto window
	bool	d_showTooltips;		//!< whether show tooltips
    ...
    // Tooltip stuff
    String32 d_tooltipText;     //!< Text string used as tip for this window.
...
protected:
	...
	*************************************************************************/
	...
	static	WindowProperties::AchorWindow		d_achorWindowProperty;
	static	WindowProperties::AchorMode			d_achorModeProperty;
	static	WindowProperties::AchorOffset		d_AchorOffsetProperty;

	static	WindowProperties::ShowTooltip		d_ShowTooltipProperty;
    ...
    */
    ...
    virtual int writeChildWindowsXML(OutStream& out_stream, const String& gap) const;
	...
	*************************************************************************/
	...
	//窗口定位的变量
	Window*			d_achorWindow;
	Window*			d_parentAchorWindow;
	AchorMode		d_achorMode;
	Point			d_achorOffset;
	...
	public:
		...
		void		setAchorMode( AchorMode mode ) { d_achorMode = mode ; };
		AchorMode	getAchorMode(void) const { return d_achorMode; };

		void			setAchorWindow( const String& name ) ;
		void			setAchorWindow( Window* win ) { d_achorWindow = win; }
		const String	getAchorWindow(void) const;

		void			setAchorParentWindow( const Window* pWin ) { d_parentAchorWindow = (Window*)pWin; }
		const Window*	getAchorParentWindow(void) const { return d_parentAchorWindow; };
		
		void			onAchorWindowDestory(void);
		void			executeAchor(void);

		const	String	getAchorOffset(void) const;
		void			setAchorOffset(Point pt);

		const	bool	getShowTooltip(void) const { return d_showTooltips; }
		void			setShowTooltip(bool setting) { d_showTooltips = setting; }
