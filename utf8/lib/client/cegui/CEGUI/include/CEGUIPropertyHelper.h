...
public:
	...
	static AchorMode stringToAchorMode(const String& str);
	...
	static String	achorModeToString( const AchorMode& val);
	static RenderableImage::HorzFormatting stringToHorzImageFormating(const String& str);
	static String ImageHorzFormatingToString( const RenderableImage::HorzFormatting& val);
	static RenderableImage::VertFormatting stringToVertImageFormating(const String& str);
	static String ImageVertFormatingToString( const RenderableImage::VertFormatting& val);
};
