...
public:
	...
	*/
	...
	typedef PropertyCallback EventCallBack;
	/*************************************************************************
	...
	*/
	Window*	loadWindowLayout(const String& filename, const String& name_prefix = "", const String& resourceGroup = "", PropertyCallback* callback = NULL, EventCallBack* evcallback = NULL,void* userdata = NULL);

	Window*	loadWindowLayout2(const String& filename, const String& name_prefix = "", const String& resourceGroup = "", PropertyCallback* callback = 0, void* userdata = 0);
