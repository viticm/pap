...
namespace CEGUI
{
	...
	public:
		...
		*************************************************************************/
		...
		void loadRawDataContainer2(const String& filename, RawDataContainer& output, const String& resourceGroup);

		virtual DataStream* openDataStream(const String& filename, const String& resourceGroup) { return 0; }

		virtual void closeDataStream(DataStream* dataStream) {}
    ...
    */
	...
	protected:
		...
		typedef std::map<String, String, String32::FastLessCompare> ResourceGroupMap;
