...
/*************************************************************************
	...
	specified XML file.	
*************************************************************************/
Window* WindowManager::loadWindowLayout(const String& filename, const String& name_prefix, const String& resourceGroup, PropertyCallback* callback, EventCallBack* evcallback,void* userdata)
{
    ...
    GUILayout_xmlHandler handler(name_prefix, callback,evcallback, userdata);
...
/*************************************************************************
	...
	specified XML file.	
*************************************************************************/
Window* WindowManager::loadWindowLayout2(const String& filename, const String& name_prefix, const String& resourceGroup, PropertyCallback* callback, void* userdata)
{
	if (filename.empty())
	{
    ...
    // create handler object
    GUILayout_xmlHandler handler(name_prefix, callback, (EventCallBack*)userdata);

	// do parse (which uses handler to create actual data)
	try
	{
        System::getSingleton().getXMLParser()->parseXMLFile2(handler,
