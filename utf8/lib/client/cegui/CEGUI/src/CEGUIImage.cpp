...
*************************************************************************/
unsigned long Image::draw(const Rect& dest_rect, float z, const Rect& clip_rect, const ColourRect& colours, QuadSplitMode quad_split_mode, bool need_quad_id) const
{
	Rect dest(dest_rect);
	...
	// draw
	return d_owner->draw(d_area, dest, z, clip_rect, colours, quad_split_mode, need_quad_id);
}
