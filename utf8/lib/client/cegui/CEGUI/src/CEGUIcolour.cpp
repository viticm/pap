...
{
	d_argb = (
		static_cast<argb_t>(fast_int(d_alpha * 255)) << 24 |
		static_cast<argb_t>(fast_int(d_red * 255)) << 16 |
		static_cast<argb_t>(fast_int(d_green * 255)) << 8 |
		static_cast<argb_t>(fast_int(d_blue * 255))
		);
	d_argbValid = true;
