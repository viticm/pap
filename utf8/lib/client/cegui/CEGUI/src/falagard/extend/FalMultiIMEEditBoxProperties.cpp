...
namespace CEGUI
{
	...
	namespace FalagardMultiIMEEditBoxProperties
	{
		...
		{
			return PropertyHelper::boolToString(static_cast<const FalagardMultiIMEEditBox*>(receiver)->getCopyPasteDisable());
		}

		void DisableCopyPaste::set(PropertyReceiver* receiver, const String& value)
		{
			static_cast<FalagardMultiIMEEditBox*>(receiver)->setCopyPasteDisable(PropertyHelper::stringToBool(value));
		}
	}
}