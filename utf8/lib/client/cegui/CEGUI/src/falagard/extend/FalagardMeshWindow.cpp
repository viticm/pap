...
namespace CEGUI
{
	...
	FalagardMeshWindowProperties::BackgroundName	FalagardMeshWindow::d_backgroundNameProperty;
	...
	void FalagardMeshWindow::setBackgroundName(const String& texName)
	{
		d_backgroundName = texName;

		if(!d_backgroundName.empty() && isVisible())
		{
