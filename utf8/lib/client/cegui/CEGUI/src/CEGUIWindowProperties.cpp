...
{
	return String(static_cast<const Window*>(receiver)->getTextOriginal().c_str());
}

void TextOriginal::set(PropertyReceiver* receiver, const String& value)
{
	static_cast<Window*>(receiver)->setTextOriginal((utf8*)(value.c_str()));
}

String Text::get(const PropertyReceiver* receiver) const
{
	return String(static_cast<const Window*>(receiver)->getText().c_str());
}


void Text::set(PropertyReceiver* receiver, const String& value)
{
	static_cast<Window*>(receiver)->setText((utf8*)(value.c_str()));
}
...
String Tooltip::get(const PropertyReceiver* receiver) const
{
	...
	{
		return String(wnd->getTooltipText().c_str());
	}
	else
	{
		return String("");
...
{
	static_cast<Window*>(receiver)->setTooltipText((utf8*)value.c_str());
}
...
String	AchorWindow::get(const PropertyReceiver* receiver) const
{
	return static_cast<const Window*>(receiver)->getAchorWindow();
}
void	AchorWindow::set(PropertyReceiver* receiver, const String& value)
{
	static_cast<Window*>(receiver)->setAchorWindow(value);
}

String	AchorMode::get(const PropertyReceiver* receiver) const
{
	return PropertyHelper::achorModeToString(static_cast<const Window*>(receiver)->getAchorMode());
}
void	AchorMode::set(PropertyReceiver* receiver, const String& value)
{
	static_cast<Window*>(receiver)->setAchorMode(PropertyHelper::stringToAchorMode(value));
}

String	AchorOffset::get(const PropertyReceiver* receiver) const
{
	return static_cast<const Window*>(receiver)->getAchorOffset();
}
void	AchorOffset::set(PropertyReceiver* receiver, const String& value)
{
	static_cast<Window*>(receiver)->setAchorOffset(PropertyHelper::stringToPoint(value));
}


String	ShowTooltip::get(const PropertyReceiver* receiver) const
{
	return PropertyHelper::boolToString( static_cast<const Window*>(receiver)->getShowTooltip() );
}
void	ShowTooltip::set(PropertyReceiver* receiver, const String& value)
{
	static_cast<Window*>(receiver)->setShowTooltip(PropertyHelper::stringToBool(value));
