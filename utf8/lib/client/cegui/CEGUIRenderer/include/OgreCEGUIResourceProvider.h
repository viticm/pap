...
namespace CEGUI
{
	...
	public:
		...
		*************************************************************************/
		...
		virtual void loadRawDataContainer2(const String& filename, RawDataContainer& output, const String& resourceGroup);
		virtual void unloadRawDataContainer(RawDataContainer& output);

		virtual DataStream* openDataStream(const String& filename, const String& resourceGroup);
