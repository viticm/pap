 ...
 * @uses the xzip module
 *  en: 
 *  form the source changed: 
 *  1. replace the XZIP_H to VENGINE_CAPABILITY_VENGINE_CAPABILITY_XZIP_H_
 *  2. add the base namespace vengine_capability
 *  cn:
 *  注意这段注释的规则，如果是引用开源的源码，做出的改动不大，
 *  则需要保留更改了什么内容
 *  这里只是将宏XZIP_H替换为VENGINE_CAPABILITY_VENGINE_CAPABILITY_XZIP_H_，
 *  并在最外围增加了一个命名空间vengine_capability
 */
// XZip.h  Version 1.3
//
...
#ifndef VENGINE_CAPABILITY_XZIP_H_
#define VENGINE_CAPABILITY_XZIP_H_
...
#ifndef XUNZIP_H //not use it by viticm
...
#endif //VENGINE_CAPABILITY_XZIP_H_
