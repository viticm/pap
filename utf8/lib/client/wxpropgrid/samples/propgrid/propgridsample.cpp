...
//#endif
    ...
    else if ( name == wxT("Margin Colour") )
    {
...
# endif
    ...
    wxPropertyGrid* pg = m_proped = new wxPropertyGrid(panel, PGID,
        ...
        //wxPG_NOCATEGORIES|
        wxTAB_TRAVERSAL |
        wxPG_DEFAULT_STYLE | wxSUNKEN_BORDER
    ...
    */
    ...
    // Additional control
    //topSizer->Add( new wxButton(this,1234), 0, wxEXPAND|wxFIXED_MINSIZE );
    ...
    panelSider->Add( panel, 1, wxEXPAND|wxFIXED_MINSIZE );
    SetSizer( panelSizer );
...
public:
    ...
    virtual bool Init ( wxOwnerDrawnComboBox* combo )
    {
...
protected:
    wxOwnerDrawnComboBox* m_odc;
    wxOwnerDrawnComboBox* m_odc2;
    wxOwnerDrawnComboBox* m_odc3;
...
void SampleFrame::OnComboItemPaint(wxOwnerDrawnComboBox* pCb,
                                   int item,
                                   wxDC& dc,
                                   wxRect& rect,
                                   int flags )
...
SampleFrame::SampleFrame( wxWindow* parent ) :
           wxFrame(parent, -1, wxT("Custom Combo Sample"), wxDefaultPosition, wxDefaultSize,
               (wxMINIMIZE_BOX|wxMAXIMIZE_BOX|wxRESIZE_BORDER|wxSYSTEM_MENU|wxCAPTION|wxCLOSE_BOX|wxTAB_TRAVERSAL|wxNO_FULL_REPAINT_ON_RESIZE) )
{
    ...
    m_odc = new wxOwnerDrawnComboBox(this,1,wxEmptyString,
                                     wxDefaultPosition, wxDefaultSize,
                                     arrItems,
    ...
    m_odc2 = new wxOwnerDrawnComboBox(this,2,wxEmptyString,
                                     wxDefaultPosition, wxDefaultSize,
                                     iface,
                                     wxNO_BORDER
                                    );
    ...
    m_odc3 = new wxOwnerDrawnComboBox(this,3,wxEmptyString,
                                     wxDefaultPosition, wxDefaultSize,
                                     iface2
                                    );
