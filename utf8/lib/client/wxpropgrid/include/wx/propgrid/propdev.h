...
#define wxPGRegisterValueType(TYPENAME) \
    ...
    { \
        wxPGValueType_##TYPENAME = wxPropertyGrid::RegisterValueType( new wxPGValueType##TYPENAME##Class ); \
    }
...
{ \
    wxPG_INIT_REQUIRED_TYPE(long_##NAME) \
...
{ \
    WX_DECLARE_DERIVED_PROPERTY_CLASS() \
public: \
...
WX_PG_IMPLEMENT_DERIVED_PROPERTY_CLASS(NAME,const wxColour&) \
