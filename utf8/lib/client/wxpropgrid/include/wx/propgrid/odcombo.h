///////////////////////////////////////////////////////////////////////////////
// Name:        odcombo.h
// Purpose:     wxOwnerDrawnComboBox and related classes interface
// Author:      Jaakko Salli
...
class WXDLLEXPORT_PGODC wxOwnerDrawnComboBox;

// ----------------------------------------------------------------------------
// wxComboPopupInterface is the interface class that lies between
// the wxOwnerDrawnComboBox and its popup window.
// ----------------------------------------------------------------------------
...
typedef void (wxEvtHandler::* wxComboPaintCallback)(wxOwnerDrawnComboBox* pCb,
                                                    int item,
                                                    wxDC& dc,
                                                    wxRect& rect,
                                                    int flags );
...
class WXDLLEXPORT_PGODC wxOwnerDrawnComboBox : public wxOwnerDrawnComboBoxBase
{
...
// a combo control needs a control for popup window it displays
    ...
    // wxOwnerDrawnComboBox-only methods
