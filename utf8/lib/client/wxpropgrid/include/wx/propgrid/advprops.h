...
WX_PG_DECLARE_PROPERTY_WITH_DECL(NAME,const wxColourPropertyValue&,*((wxColourPropertyValue*)NULL),WXDLLIMPEXP_PG)

#define WX_PG_DECLARE_CUSTOM_COLOUR_PROPERTY(NAME) \
WX_PG_DECLARE_PROPERTY(NAME,const wxColourPropertyValue&,*((wxColourPropertyValue*)NULL))

#define WX_PG_DECLARE_CUSTOM_COLOUR_PROPERTY_USES_WXCOLOUR_WITH_DECL(NAME,DECL) \
WX_PG_DECLARE_PROPERTY_WITH_DECL(NAME,const wxColour&,*wxBLACK,WXDLLIMPEXP_PG)

#define WX_PG_DECLARE_CUSTOM_COLOUR_PROPERTY_USES_WXCOLOUR(NAME) \
WX_PG_DECLARE_PROPERTY(NAME,const wxColour&,*wxBLACK))
