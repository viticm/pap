...
void wxFontPropertyClass::ChildChanged ( wxPGProperty* p )
{
    ...
    {
        case 0: m_value_wxFont.SetPointSize ( p->DoGetValue().GetRawLong() ); break;
        case 1: m_value_wxFont.SetFamily ( p->DoGetValue().GetRawLong() ); break;
        case 2: m_value_wxFont.SetFaceName ( *((wxString*)p->DoGetValue().GetRawPtr()) ); break;
        case 3: m_value_wxFont.SetStyle ( p->DoGetValue().GetRawLong() ); break;
        case 4: m_value_wxFont.SetWeight ( p->DoGetValue().GetRawLong() ); break;
        case 5: m_value_wxFont.SetUnderlined ( p->DoGetValue().GetBool()?TRUE:FALSE ); break;
    }
}
