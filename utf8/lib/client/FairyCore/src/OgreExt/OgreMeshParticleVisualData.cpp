...
namespace Ogre	{
    ...
    //-----------------------------------------------------------------------
	void MeshParticleVisualData::createVisualData(const Ogre::String &meshName, const Ogre::String &matName, Node* parentNode)
	{
    ...
    //-----------------------------------------------------------------------
	void MeshParticleVisualData::setScale( Ogre::Real xzSize, Ogre::Real ySize )
	{
    ...
    //-----------------------------------------------------------------------
	void MeshParticleVisualData::modifyMesh(const Ogre::String &meshName)
	{
		// destroy old entity
		assert(mEntity);
    ...
    //-----------------------------------------------------------------------
	void MeshParticleVisualData::modifyMaterial(const Ogre::String &matName)
	{
		assert(mEntity);
    ...
    //-----------------------------------------------------------------------
	void MeshParticleVisualData::cloneMaterial(const Ogre::String& matName)
	{
		// clone material
