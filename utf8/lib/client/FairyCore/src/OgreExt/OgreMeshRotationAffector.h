...
namespace Ogre {
    ...
    */
    ...
    public:
		...
		inline void setRotationSpeedRangeStart(Ogre::Real angle, RotationType type) {
...
#ifndef OGRE_FORCE_ANGLE_TYPES
		inline void setRotationSpeedRangeEnd(Ogre::Real angle, RotationType type) {
...
#ifndef OGRE_FORCE_ANGLE_TYPES
		inline void setRotationRangeStart(Ogre::Real angle, RotationType type) {
...
#ifndef OGRE_FORCE_ANGLE_TYPES
		inline void setRotationRangeEnd(Ogre::Real angle, RotationType type) {
