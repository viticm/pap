...
-----------------------------------------------------------------------------
*/
#ifndef __MeshRotationAffectorFactory_H__
#define __MeshRotationAffectorFactory_H__
...
namespace Ogre {
    ...
    class MeshRotationAffectorFactory : public ParticleAffectorFactory
    {
       ...
       Ogre::String getName() const { return "MeshRotator"; }

        /** See ParticleAffectorFactory */
        ParticleAffector* createAffector(ParticleSystem* psys)
        {
            ParticleAffector* p = new MeshRotationAffector(psys);
