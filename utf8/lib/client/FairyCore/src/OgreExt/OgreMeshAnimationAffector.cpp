...
namespace Ogre {
	...
	//-----------------------------------------------------------------------
	void MeshAnimationAffector::_affectParticles(ParticleSystem* pSystem, Ogre::Real timeElapsed)
	{
	...
	void MeshAnimationAffector::CmdAnimationName::doSet(void* target, const Ogre::String& val)
	{
	...
	void MeshAnimationAffector::CmdAnimationLoop::doSet(void* target, const Ogre::String& val)
	{
		static_cast<MeshAnimationAffector*>(target)->setAnimationLoop(StringConverter::parseBool(val));
	}
    //-----------------------------------------------------------------------
   Ogre::String MeshAnimationAffector::CmdAnimationSpeedFactor::doGet(const void* target) const
    {
        return Ogre::StringConverter::toString(
            static_cast<const MeshAnimationAffector*>(target)->getAnimationSpeedFactor() );
    }
    void MeshAnimationAffector::CmdAnimationSpeedFactor::doSet(void* target, const Ogre::String& val)
    {
