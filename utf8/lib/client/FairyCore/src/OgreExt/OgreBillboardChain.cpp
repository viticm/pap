...
namespace Ogre {
   ...
   Ogre::Real EffectBillboardChain::getSquaredViewDepth(const Camera* cam) const
   {
   ...
   Ogre::Real EffectBillboardChain::getBoundingRadius(void) const
   {
       return mRadius;
   }
