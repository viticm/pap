...
namespace Ogre {
	...
	*/
	...
	{
	public:
		void _setDimensions(bool o, Ogre::Real w, Ogre::Real h)
		{
			if (mOwnDimensions = o)
			{
				mWidth = w;
	...
	//-----------------------------------------------------------------------
	const Ogre::String& TexCoordBillboardParticleRenderer::getType(void) const
	{
	...
	{	
		...
		Ogre::ulong numTexCoords = mSlices * mStacks;
	//	--numTexCoords;

		Ogre::Real life_time = 0.0f;
		Ogre::Real particle_time = 0.0f;
		Ogre::Real repeatedParticleTime = 0.0f;
		uint16 texCoords = 0;
	...
	//-----------------------------------------------------------------------
	void TexCoordBillboardParticleRenderer::setStacks(Ogre::ulong stacks)
	{
		if (stacks < 1)
			mStacks = 1;
		else
	...
	//-----------------------------------------------------------------------
	void TexCoordBillboardParticleRenderer::setSlices(Ogre::ulong slices)
	{
		if (slices < 1)
			mSlices = 1;
		else
	...
	//-----------------------------------------------------------------------
	//-----------------------------------------------------------------------
	const Ogre::String& TexCoordBillboardParticleRendererFactory::getType() const
	{
		return rendererTypeName;
	}
	//-----------------------------------------------------------------------
	...
	void TexCoordBillboardParticleRenderer::CmdStacks::doSet(void* target, const Ogre::String& val)
	{
	...
	void TexCoordBillboardParticleRenderer::CmdSlices::doSet(void* target, const Ogre::String& val)
	{
	...
	void TexCoordBillboardParticleRenderer::CmdRepeatTimes::doSet(void* target, const Ogre::String& val)
	{
