...
namespace Ogre {
	...
	//-----------------------------------------------------------------------
	void MeshRotationAffector::_affectParticles(ParticleSystem* pSystem, Ogre::Real timeElapsed)
	{
	...
	void MeshRotationAffector::CmdYawRotationSpeedRangeEnd::doSet(void* target, const Ogre::String& val)
	{
	...
	void MeshRotationAffector::CmdYawRotationSpeedRangeStart::doSet(void* target, const Ogre::String& val)
	{
	...
	void MeshRotationAffector::CmdYawRotationRangeEnd::doSet(void* target, const Ogre::String& val)
	{
	...
	void MeshRotationAffector::CmdYawRotationRangeStart::doSet(void* target, const Ogre::String& val)
	{
	...
	void MeshRotationAffector::CmdPitchRotationSpeedRangeEnd::doSet(void* target, const Ogre::String& val)
	{
	...
	void MeshRotationAffector::CmdPitchRotationSpeedRangeStart::doSet(void* target, const Ogre::String& val)
	{
	...
	void MeshRotationAffector::CmdPitchRotationRangeEnd::doSet(void* target, const Ogre::String& val)
	{
	...
	void MeshRotationAffector::CmdPitchRotationRangeStart::doSet(void* target, const Ogre::String& val)
	{
	...
	void MeshRotationAffector::CmdRollRotationSpeedRangeEnd::doSet(void* target, const Ogre::String& val)
	{
	...
	void MeshRotationAffector::CmdRollRotationSpeedRangeStart::doSet(void* target, const Ogre::String& val)
	{
	...
	void MeshRotationAffector::CmdRollRotationRangeEnd::doSet(void* target, const Ogre::String& val)
	{
	...
	void MeshRotationAffector::CmdRollRotationRangeStart::doSet(void* target, const Ogre::String& val)
	{
