...
public:
	...
	virtual void _notifyColourModified(int xstart, int zstart, int xend, int zend);
	virtual void _notifyLightColourModified(int xstart, int zstart, int xend, int zend);
public:
