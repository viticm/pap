...
namespace Fairy {
    ...
    public:
        ...
        void writeString(const Ogre::String& string);
    ...
    public:
       ...
       Ogre::String readString(void);
       Ogre::String readString(size_t numChars);
    ...
    public:
        ...
        explicit FileWriter(const Ogre::String& filename)
