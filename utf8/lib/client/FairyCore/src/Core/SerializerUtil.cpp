...
#	endif
    ...
    //---------------------------------------------------------------------
    void Writer::writeString(const Ogre::String& string)
    {
...
#	endif
    ...
    //---------------------------------------------------------------------
   Ogre::String Reader::readString(size_t numChars)
    {
       Ogre::String str(numChars, '\0');
        _read(const_cast<String::value_type*>(str.data()), sizeof(String::value_type), numChars);
        return str;
    }
    //---------------------------------------------------------------------
   Ogre::String Reader::readString(void)
    {
        uint32 numChars;
        readInts(&numChars);
