...
namespace Fairy
{
    ...
    public:
        ...
        void load(XMLParser* parser, const Ogre::String& filename, const Ogre::String& groupName, bool completely);
        void save(XMLWriter* writer, const Ogre::String& filename);
