...
namespace Fairy
{
    ...
    XMLNode::XMLNode(const Ogre::String& name)
        : mParent(NULL)
        , mName(name)
        , mTextContent()
        , mAttributes()
    ...
    void XMLNode::setTextContent(const Ogre::String& textContent)
    {
        mTextContent = textContent;
    }

    const Ogre::String& XMLNode::getTextContent(void) const
    {
        return mTextContent;
    }

    XMLNode* XMLNode::createChild(const Ogre::String& name)
    {
