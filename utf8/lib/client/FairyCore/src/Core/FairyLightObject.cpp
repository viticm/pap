...
namespace Fairy
{
    const Ogre::String LightObject::msType = "Light";
    const Ogre::String LightObject::msCategory = "Light";
    ...
    namespace
    {
        ...
        typedef ObjectMemberPropertyCommand<LightObject, Ogre::Real, &LightObject::mRange> RangeCmd;
        typedef ObjectMemberPropertyCommand<LightObject, Ogre::Real, &LightObject::mAttenuationConstant> AttenuationConstantCmd;
        typedef ObjectMemberPropertyCommand<LightObject, Ogre::Real, &LightObject::mAttenuationLinear> AttenuationLinearCmd;
        typedef ObjectMemberPropertyCommand<LightObject, Ogre::Real, &LightObject::mAttenuationQuadric> AttenuationQuadricCmd;
        typedef ObjectMemberPropertyCommand<LightObject, Ogre::Real, &LightObject::mSpotOuterAngle> SpotOuterAngleCmd;
        typedef ObjectMemberPropertyCommand<LightObject, Ogre::Real, &LightObject::mSpotInnerAngle> SpotInnerAngleCmd;
        typedef ObjectMemberPropertyCommand<LightObject, Ogre::Real, &LightObject::mSpotFalloff> SpotFalloffCmd;
    ...
    //-----------------------------------------------------------------------
    const Ogre::String& LightObject::getType(void) const
    {
        return msType;
    }
    //-----------------------------------------------------------------------
    const Ogre::String& LightObject::getCategory(void) const
    {
        return msCategory;
    }
    //-----------------------------------------------------------------------
    ...
    //-----------------------------------------------------------------------
    Ogre::uint LightObject::getPropertyFlags(const Ogre::String& name) const
    {
