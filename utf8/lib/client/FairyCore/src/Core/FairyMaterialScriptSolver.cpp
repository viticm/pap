#include "FairyMaterialScriptSolver.h"
...
namespace Fairy {
    ...
    public:
        ...
        {
            static const Ogre::String name = "MaterialScript";
            return name;
        }
        ...
        bool commitPermanent(void)
        {
            ...
            typedef std::map<ResourceLocation,Ogre::String> ResourceLocationFilenameMap;
            ...
            for (ResourceLocationSet::const_iterator it = modifiedScripts.begin(); it != modifiedScripts.end(); ++it)
            {
               ...
               Ogre::StringVectorPtr filenames = findResourceFilenames(resourceLocation.first, resourceLocation.second);
                ...
                {
                    const Ogre::String& filename = *filenames->begin();
            ...
            while (mi.hasMoreElements())
            {
                ...
                const Ogre::String& groupName = material->getGroup();
                const Ogre::String& scriptName = material->getOrigin();
    ...
    ResourceSolverPtr findUnsolvedMaterialTextures(const Ogre::String& group)
    {
        ...
        typedef std::map<String,Ogre::StringVectorPtr> PossibleMap;
        ...
        while (mi.hasMoreElements())
        {
            ...
            const Ogre::String& materialName = material->getName();
            const Ogre::String& scriptName = material->getOrigin();
            ...
            while (ti.hasMoreElements())
            {
                ...
                while (pi.hasMoreElements())
                {
                    ...
                    while (tusi.hasMoreElements())
                    {
                        ...
                        {
                            const Ogre::String& textureName = tus->getFrameTextureName(frame);
                            ...
                            else
                            {
                               ...
                               Ogre::String scriptBasename, scriptPath;
