#include "FairyTerrainProjector.h"
#include "Terrain.h"
...
#define VERTEX_SOURCE           0
    ...
    const Ogre::String TerrainProjector::msMovableType = "TerrainProjector";
    Ogre::uint TerrainProjector::ms_uGenNameCount = 0;
    ...
    //-----------------------------------------------------------------------
    void TerrainProjector::setPatchMaterial(const Ogre::String& materialName)
    {
        mPatchMaterialName = materialName;
        mPatchMaterialDirty = true;
    }
    //-----------------------------------------------------------------------
    const Ogre::String& TerrainProjector::getPatchMaterialName(void)
    {
        return mPatchMaterialName;
    }
    //-----------------------------------------------------------------------
    const Ogre::String& TerrainProjector::getMovableType(void) const
    {
