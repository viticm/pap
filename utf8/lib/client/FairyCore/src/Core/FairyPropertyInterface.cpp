...
namespace Fairy
{
    ...
    void PropertyInterface::defineProperty(const Ogre::String& name,
                                           ...
                                           Ogre::uint flags)
    {
        getPropertyDictionary()->addProperty(
            PropertyDef(name,
                        description,
                        type,
                        propertyCmd ? propertyCmd->doGetAsString(this) :Ogre::String(),
                        flags),
            propertyCmd);
    }
    //-----------------------------------------------------------------------
    ...
    //-----------------------------------------------------------------------
    bool PropertyInterface::hasProperty(const Ogre::String& name) const
    {
        // Get dictionary
        const PropertyDictionary* dict = getPropertyDictionary();
    ...
    //-----------------------------------------------------------------------
    bool PropertyInterface::setProperty(const Ogre::String& name, const Variant& value)
    {
        // Get dictionary
    ...
    //-----------------------------------------------------------------------
    bool PropertyInterface::setPropertyAsString(const Ogre::String& name, const Ogre::String& value)
    {
        // Get dictionary
        PropertyDictionary* dict = getPropertyDictionary();
    ...
    //-----------------------------------------------------------------------
    Variant PropertyInterface::getProperty(const Ogre::String& name) const
    {
        // Get dictionary
        const PropertyDictionary* dict = getPropertyDictionary();
    ...
    //-----------------------------------------------------------------------
   Ogre::String PropertyInterface::getPropertyAsString(const Ogre::String& name) const
    {
        // Get dictionary
        const PropertyDictionary* dict = getPropertyDictionary();
    ...
    //-----------------------------------------------------------------------
    Ogre::uint PropertyInterface::getPropertyFlags(const Ogre::String& name) const
    {
        // Get dictionary
        const PropertyDictionary* dict = getPropertyDictionary();
