/********************************************************************
filename:   FairyBillboardSetElement.cpp
...
namespace Fairy	{
	...
	//////////////////////////////////////////////////////////////////////////
	BillboardSetElement::BillboardSetElement(const Ogre::String &type, System *system) :
	...
	{	
		...
		if (mBillboardSet )
		{
			...
			mSystem->getSceneManager()->destroyBillboardSet(mBillboardSet);
		}
	}
    //---------------------------------------------------------------------
    ...
    //---------------------------------------------------------------------
    void BillboardSetElement::updateRenderInstance( Ogre::Real time, TransformInfo &info )
    {
        if (mBillboardSet)
        {
            ...
            for ( int i = 0; i < mBillboardSet->getNumBillboards(); ++i )
            {
                ...
                if (mSizeChanged)
                {
                    ...
                    Ogre::Real rate = colourPersent / mScaleIntervalTime;
	...
	//---------------------------------------------------------------------
	void BillboardSetElement::setBillboardMaterial(const Ogre::String &material)
	{
	...
	//---------------------------------------------------------------------
	void BillboardSetElement::setBillboardInterval(Ogre::Real interval)
	{
	...
	//---------------------------------------------------------------------
	void BillboardSetElement::setBillboardWidth(Ogre::Real width)
	{
	...
	//---------------------------------------------------------------------
	void BillboardSetElement::setBillboardHeight(Ogre::Real height)
	{
    ...
    //---------------------------------------------------------------------
    void BillboardSetElement::setStacks(Ogre::ulong stacks)
    {
        if (stacks < 1)
            mStacks = 1;
        else
    ...
    //-----------------------------------------------------------------------
    void BillboardSetElement::setSlices(Ogre::ulong slices)
    {
        if (slices < 1)
            mSlices = 1;
        else
	...
	void BillboardSetElement::CmdBillboardColour::doSet(void* target, const Ogre::String& val)
	{
...
#endif
    //-----------------------------------------------------------------------
   Ogre::String BillboardSetElement::CmdBillboardScale::doGet(const void* target) const
    {
        return Ogre::StringConverter::toString(
            static_cast<const BillboardSetElement *>(target)->getBillboardScale(mIndex) );
    }
    void BillboardSetElement::CmdBillboardScale::doSet(void* target, const Ogre::String& val)
    {
...
#endif
    //-----------------------------------------------------------------------
   Ogre::String BillboardSetElement::CmdScaleIntervalTime::doGet(const void* target) const
    {
        return Ogre::StringConverter::toString(
            static_cast<const BillboardSetElement *>(target)->getScaleIntervalTime() );
    }
    void BillboardSetElement::CmdScaleIntervalTime::doSet(void* target, const Ogre::String& val)
    {
...
#endif
    //-----------------------------------------------------------------------
   Ogre::String BillboardSetElement::CmdBillboardAlpha::doGet(const void* target) const
    {
        return Ogre::StringConverter::toString(
            static_cast<const BillboardSetElement *>(target)->getBillboardAlpha() );
    }
    void BillboardSetElement::CmdBillboardAlpha::doSet(void* target, const Ogre::String& val)
    {
	...
	void BillboardSetElement::CmdBillboardCount::doSet(void* target, const Ogre::String& val)
	{
	...
	void BillboardSetElement::CmdBillboardMaterial::doSet(void* target, const Ogre::String& val)
	{
	...
	void BillboardSetElement::CmdBillboardInterval::doSet(void* target, const Ogre::String& val)
	{
	...
	void BillboardSetElement::CmdBillboardHeight::doSet(void* target, const Ogre::String& val)
	{
	...
	void BillboardSetElement::CmdBillboardWidth::doSet(void* target, const Ogre::String& val)
	{
...
#endif
    //-----------------------------------------------------------------------
   Ogre::String BillboardSetElement::CmdStacks::doGet(const void* target) const
    {
        return Ogre::StringConverter::toString(
            static_cast<const BillboardSetElement*>(target)->getStacks() );
    }
    void BillboardSetElement::CmdStacks::doSet(void* target, const Ogre::String& val)
    {
...
#endif
    //-----------------------------------------------------------------------
   Ogre::String BillboardSetElement::CmdSlices::doGet(const void* target) const
    {
        return Ogre::StringConverter::toString(
            static_cast<const BillboardSetElement*>(target)->getSlices() );
    }
    void BillboardSetElement::CmdSlices::doSet(void* target, const Ogre::String& val)
    {
...
#endif
    //-----------------------------------------------------------------------
   Ogre::String BillboardSetElement::CmdTexIntervalTime::doGet(const void* target) const
    {
        return Ogre::StringConverter::toString(
            static_cast<const BillboardSetElement *>(target)->getTexIntervalTime() );
    }
    void BillboardSetElement::CmdTexIntervalTime::doSet(void* target, const Ogre::String& val)
    {
