...
namespace Fairy	{
	...
	//-----------------------------------------------------------------------
	void AnimationRibbon::setMaterialName(const Ogre::String &matName)
	{
	...
	void AnimationRibbon::CmdPointCount::doSet(void* target, const Ogre::String& val)
	{
	...
	void AnimationRibbon::CmdRibbonWidth::doSet(void* target, const Ogre::String& val)
	{
	...
	void AnimationRibbon::CmdStartColour::doSet(void* target, const Ogre::String& val)
	{
	...
	void AnimationRibbon::CmdEndColour::doSet(void* target, const Ogre::String& val)
	{
	...
	void AnimationRibbon::CmdStartAlpha::doSet(void* target, const Ogre::String& val)
	{
	...
	void AnimationRibbon::CmdEndAlpha::doSet(void* target, const Ogre::String& val)
	{
...
#endif
    //-----------------------------------------------------------------------
   Ogre::String AnimationRibbon::CmdFadeInTime::doGet(const void* target) const
    {
        return Ogre::StringConverter::toString(
            static_cast<const AnimationRibbon *>(target)->getFadeInTime() );
    }
    void AnimationRibbon::CmdFadeInTime::doSet(void* target, const Ogre::String& val)
    {
...
#endif
    //-----------------------------------------------------------------------
   Ogre::String AnimationRibbon::CmdFadeOutTime::doGet(const void* target) const
    {
        return Ogre::StringConverter::toString(
            static_cast<const AnimationRibbon *>(target)->getFadeOutTime() );
    }
    void AnimationRibbon::CmdFadeOutTime::doSet(void* target, const Ogre::String& val)
    {
	...
	void AnimationRibbon::CmdMaterial::doSet(void* target, const Ogre::String& val)
	{
	...
	void AnimationRibbon::CmdLifeTime::doSet(void* target, const Ogre::String& val)
	{
	...
	void AnimationRibbon::CmdAttachTime::doSet(void* target, const Ogre::String& val)
	{
	...
	void AnimationRibbon::CmdAttachPoint::doSet(void* target, const Ogre::String& val)
	{
	...
	void AnimationRibbon::CmdOffsetPos::doSet(void* target, const Ogre::String& val)
	{
	...
	void AnimationRibbon::CmdOffsetRotation::doSet(void* target, const Ogre::String& val)
	{
	...
	void AnimationRibbon::CmdUseInter::doSet(void* target, const Ogre::String& val)
	{
	...
	void AnimationRibbon::CmdInterTimes::doSet(void* target, const Ogre::String& val)
	{
...
#endif
    //-----------------------------------------------------------------------
   Ogre::String AnimationRibbon::CmdVertexLifeTime::doGet(const void* target) const
    {
        return Ogre::StringConverter::toString(
            static_cast<const AnimationRibbon *>(target)->getVertexLifeTime() );
    }
    void AnimationRibbon::CmdVertexLifeTime::doSet(void* target, const Ogre::String& val)
    {
