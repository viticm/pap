...
namespace Fairy	{
	...
	//---------------------------------------------------------------------
	AnimationBulletFlow* Skill::addAnimationBulletFlow(void)
	{
		AnimationBulletFlow *bulletFlow = new AnimationBulletFlow();
		assert (bulletFlow);

		mAnimationBulletFlows.push_back(bulletFlow);

		return bulletFlow;
	}
	//---------------------------------------------------------------------
	AnimationBulletFlow* Skill::getAnimationBulletFlow(unsigned short index) const
	{
		assert(index < mAnimationBulletFlows.size() && "Animation bullet flow index out of bounds!");
		return mAnimationBulletFlows[index];
	}
	//---------------------------------------------------------------------
	unsigned short Skill::getNumAnimationBulletFlows(void) const
	{
		return static_cast<unsigned short>( mAnimationBulletFlows.size() );
	}
	//---------------------------------------------------------------------
	void Skill::removeAnimationBulletFlow(unsigned short index)
	{
		assert(index < mAnimationBulletFlows.size() && "Animation bullet flow index out of bounds!");
		AnimationBulletFlows::iterator bi = mAnimationBulletFlows.begin() + index;
		...
		mAnimationBulletFlows.erase(bi);
	}
	//---------------------------------------------------------------------
	void Skill::removeAllAnimationBulletFlows(void)
	{
		for ( AnimationBulletFlows::iterator i = mAnimationBulletFlows.begin(); i != mAnimationBulletFlows.end(); ++i )
		{
			if (*i)
			{
				delete *i;
	...
	//---------------------------------------------------------------------
	AnimationCameraShake* Skill::addAnimationCameraShake(void)
	{
		AnimationCameraShake *cameraShake = new AnimationCameraShake(mSystem);
		assert (cameraShake);
	...
	//---------------------------------------------------------------------
	AnimationCameraShake* Skill::getAnimationCameraShake(unsigned short index) const
	{
		assert(index < mAnimationCameraShakes.size() && "Animation camera shakes index out of bounds!");
		return mAnimationCameraShakes[index];
	}
	//---------------------------------------------------------------------
	unsigned short Skill::getNumAnimationCameraShake(void) const
	{
		return static_cast<unsigned short>( mAnimationCameraShakes.size() );
	}
	//---------------------------------------------------------------------
	void Skill::removeAnimationCameraShake(unsigned short index)
	{
		assert(index < mAnimationCameraShakes.size() && "Animation camera shakes index out of bounds!");
	...
	//---------------------------------------------------------------------
	void Skill::removeAllAnimationCameraShakes(void)
	{
	...
	//---------------------------------------------------------------------
	void Skill::setHitTimeFromString(const Ogre::String &hitTimeStr)
	{
		mHitTimeArray.clear();
	...
	void Skill::CmdAnimationName::doSet(void* target, const Ogre::String& val)
	{
	...
	void Skill::CmdBreakTime::doSet(void* target, const Ogre::String& val)
	{
	...
	void Skill::CmdHitTime::doSet(void* target, const Ogre::String& val)
	{
	...
	void Skill::CmdShakeTime::doSet(void* target, const Ogre::String& val)
	{
...
#endif
    //-----------------------------------------------------------------------
   Ogre::String Skill::CmdRepeatEffect::doGet(const void* target) const
    {
        return Ogre::StringConverter::toString( 
            static_cast<const Skill *>(target)->getRepeatEffect() );
    }
    void Skill::CmdRepeatEffect::doSet(void* target, const Ogre::String& val)
    {
