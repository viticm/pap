...
namespace Fairy	{
	...
	ProjectorElement::ProjectorElement(const Ogre::String &type, System *system) :
	EffectElement(type, system),
	mProjector(NULL),
	mMaterialName(""),
	mProjectionSize(100.0f),
	...
	//---------------------------------------------------------------------
	void ProjectorElement::updateRenderInstance( Ogre::Real time, TransformInfo &info )
	{
	...
	bool ProjectorElement::_createProjector(void)
	{
		...
		if (parent)
		{
			...
			mProjector->setOrthoWindowHeight(mProjectionSize);
	...
	void ProjectorElement::_updateProjectorScale(void)
	{
		...
		{
			Ogre::Real			projector_time	= fmod( mCurrentLifeTime / mScaleChangeTime, 1.0f );
	...
	void ProjectorElement::_updateProjectorColour(void)
	{
		...
		{
			Ogre::Real			projector_time	= fmod( mCurrentLifeTime / mColourChangeTime, 1.0f );
	...
	//---------------------------------------------------------------------
	void ProjectorElement::setMaterialName(const Ogre::String &name)
	{
		mMaterialName = name;
	...
	Ogre::Radian ProjectorElement::_getFovFromProjectionSize(void)
	{
		...
		*/
        ...
        Ogre::Real nearClip = mProjector->getNearClipDistance();
	...
	void ProjectorElement::setProjectionSize(float size)
	{
		...
		if (mProjector)
		{
			mProjector->setOrthoWindowHeight( size);
		}
	}
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	void ProjectorElement::setScaleTimeAdjust(size_t index, Ogre::Real time)
	{
		mScaleTimeAdj[index] = time;
	}
	//-----------------------------------------------------------------------
	Ogre::Real ProjectorElement::getScaleTimeAdjust(size_t index) const
	{
	...
	//-----------------------------------------------------------------------
	void ProjectorElement::setColourTimeAdjust(size_t index, Ogre::Real time)
	{
		mColourTimeAdj[index] = time;
	}
	//-----------------------------------------------------------------------
	Ogre::Real ProjectorElement::getColourTimeAdjust(size_t index) const
	{
		return mColourTimeAdj[index];
	}	
	//-----------------------------------------------------------------------
	void ProjectorElement::setScaleChangeTime(Ogre::Real time)
	{
		mScaleChangeTime = time;
	}
	//-----------------------------------------------------------------------
	void ProjectorElement::setColourChangeTime(Ogre::Real time)
	{
    ...
    //-----------------------------------------------------------------------
    void ProjectorElement::setNearClipDistance(Ogre::Real dis)
    {
    ...
    //-----------------------------------------------------------------------
    void ProjectorElement::setFarClipDistance(Ogre::Real dis)
    {
	...
	void ProjectorElement::CmdMaterialName::doSet(void* target, const Ogre::String& val)
	{
	...
	void ProjectorElement::CmdProjectionSize::doSet(void* target, const Ogre::String& val)
	{
	...
	void ProjectorElement::CmdScaleAdjust::doSet(void* target, const Ogre::String& val)
	{
	...
	void ProjectorElement::CmdScaleTimeAdjust::doSet(void* target, const Ogre::String& val)
	{
	...
	void ProjectorElement::CmdColourAdjust::doSet(void* target, const Ogre::String& val)
	{
	...
	void ProjectorElement::CmdColourTimeAdjust::doSet(void* target, const Ogre::String& val)
	{
	...
	void ProjectorElement::CmdScaleChangeTime::doSet(void* target, const Ogre::String& val)
	{
	...
	void ProjectorElement::CmdColourChangeTime::doSet(void* target, const Ogre::String& val)
	{
...
#endif
    //-----------------------------------------------------------------------
   Ogre::String ProjectorElement::CmdShowFrustum::doGet(const void* target) const
    {
        return Ogre::StringConverter::toString(
            static_cast<const ProjectorElement*>(target)->getShowFrustum() );
    }
    void ProjectorElement::CmdShowFrustum::doSet(void* target, const Ogre::String& val)
    {
...
#endif
    //-----------------------------------------------------------------------
   Ogre::String ProjectorElement::CmdNearClipDistance::doGet(const void* target) const
    {
        return Ogre::StringConverter::toString(
            static_cast<const ProjectorElement*>(target)->getNearClipDistance() );
    }
    void ProjectorElement::CmdNearClipDistance::doSet(void* target, const Ogre::String& val)
    {
...
#endif
    //-----------------------------------------------------------------------
   Ogre::String ProjectorElement::CmdFarClipDistance::doGet(const void* target) const
    {
        return Ogre::StringConverter::toString(
            static_cast<const ProjectorElement*>(target)->getFarClipDistance() );
    }
    void ProjectorElement::CmdFarClipDistance::doSet(void* target, const Ogre::String& val)
    {
