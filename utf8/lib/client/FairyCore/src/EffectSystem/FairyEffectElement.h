...
namespace Fairy	{
	...
	public:
		/////////////////////////////////////////////////////////////
		EffectElement(const Ogre::String &type, System *system);
		virtual ~EffectElement();

		const Ogre::String &getType(void) const 	{	return mElementType;	}
		...
		void update( Ogre::Real time, TransformInfo &info );
		...
		@param time second
		*/
		virtual void setStartTime(Ogre::Real time)	{	mStartTime = time;	}
		/**	get the born time of this element
		@param time second
		*/
		Ogre::Real getStartTime(void)	const {	return mStartTime;	}
	...
	protected:
        ...
        bool initDefaults(const Ogre::String &mType);

	protected:
	
	   Ogre::String mElementType;		
