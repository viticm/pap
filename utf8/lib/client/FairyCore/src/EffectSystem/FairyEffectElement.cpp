/********************************************************************
filename:   FairyEffectElement.cpp
...
namespace Fairy	{
	...
	EffectElement::EffectElement(const Ogre::String &type, System *system)	:
	EffectBasic(system),
	mElementType(type),
	mEffectParent(NULL),	
	...
	void EffectElement::update( Ogre::Real time, TransformInfo &info )
	{
		// calculate the born time
		Ogre::Real currentStartTime = mCurrentStartTime + time;
	...
	//---------------------------------------------------------------------
	bool EffectElement::initDefaults(const Ogre::String &mType)
	{		
    ...
    void EffectElement::CmdStartTime::doSet(void* target, const Ogre::String& val)
    {
    ...
    void EffectElement::CmdLifeTime::doSet(void* target, const Ogre::String& val)
    {
    ...
    void EffectElement::CmdRelPos::doSet(void* target, const Ogre::String& val)
    {
...
#endif
    //---------------------------------------------------------------------
   Ogre::String EffectElement::CmdRelOrientation::doGet(const void* target) const
    {
        return Ogre::StringConverter::toString(
            static_cast<const EffectElement *>(target)->getRelOrientation() );
    }
    void EffectElement::CmdRelOrientation::doSet(void* target, const Ogre::String& val)
    {
