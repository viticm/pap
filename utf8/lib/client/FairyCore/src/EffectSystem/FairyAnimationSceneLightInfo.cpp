/********************************************************************
filename:   FairyAnimationSceneLightInfo.cpp
...
namespace Fairy
{
    ...
    //////////////////////////////////////////////////////////////////////////
   Ogre::String AnimationSceneLightInfo::CmdAttachTime::doGet(const void* target) const
    {
        return Ogre::StringConverter::toString(
            static_cast<const AnimationSceneLightInfo *>(target)->getAttachTime() );
    }
    void AnimationSceneLightInfo::CmdAttachTime::doSet(void* target, const Ogre::String& val)
    {
   ...
   Ogre::String AnimationSceneLightInfo::CmdLastTime::doGet(const void* target) const
    {
        return Ogre::StringConverter::toString(
            static_cast<const AnimationSceneLightInfo *>(target)->getLastTime() );
    }
    void AnimationSceneLightInfo::CmdLastTime::doSet(void* target, const Ogre::String& val)
    {
   ...
   Ogre::String AnimationSceneLightInfo::CmdFadeInTime::doGet(const void* target) const
    {
        return Ogre::StringConverter::toString(
            static_cast<const AnimationSceneLightInfo *>(target)->getFadeInTime() );
    }
    void AnimationSceneLightInfo::CmdFadeInTime::doSet(void* target, const Ogre::String& val)
    {
   ...
   Ogre::String AnimationSceneLightInfo::CmdFadeOutTime::doGet(const void* target) const
    {
        return Ogre::StringConverter::toString(
            static_cast<const AnimationSceneLightInfo *>(target)->getFadeOutTime() );
    }
    void AnimationSceneLightInfo::CmdFadeOutTime::doSet(void* target, const Ogre::String& val)
    {
   ...
   Ogre::String AnimationSceneLightInfo::CmdDestColour::doGet(const void* target) const
    {
        return Ogre::StringConverter::toString(
            static_cast<const AnimationSceneLightInfo *>(target)->getDestColour() );
    }
    void AnimationSceneLightInfo::CmdDestColour::doSet(void* target, const Ogre::String& val)
    {
