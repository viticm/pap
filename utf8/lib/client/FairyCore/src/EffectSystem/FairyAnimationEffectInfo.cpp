/********************************************************************
filename:   FairyAnimationEffectInfo.cpp
...
namespace Fairy	{
	...
	AnimationEffectInfo::~AnimationEffectInfo()
	{
		if (mEffect)
		{
			EffectManager::getSingleton().removeEffect(mEffect,false,true);
			mEffect = NULL;
		}	
	}
    //---------------------------------------------------------------------
	...
	void AnimationEffectInfo::CmdAttachTime::doSet(void* target, const Ogre::String& val)
	{
	...
	void AnimationEffectInfo::CmdAttachPoint::doSet(void* target, const Ogre::String& val)
	{
	...
	void AnimationEffectInfo::CmdEffectTemplateName::doSet(void* target, const Ogre::String& val)
	{
	...
	void AnimationEffectInfo::CmdOffsetPos::doSet(void* target, const Ogre::String& val)
	{
	...
	void AnimationEffectInfo::CmdOffsetRotation::doSet(void* target, const Ogre::String& val)
	{
	...
	void AnimationEffectInfo::CmdAttach::doSet(void* target, const Ogre::String& val)
	{
