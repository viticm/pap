/********************************************************************
filename:   FairyMainSceneLight.cpp
...
namespace Fairy
{
    ...
    void MainSceneLight::updateLightInfo(void)
    {
        ...
        const ObjectPtr lightOneObject = sceneInfo->findObjectByName("#MainLightOne");
        ...
        {
            Ogre::LogManager::getSingleton().logMessage("can't find the light with the name '#MainLightOne' "
                "MainSceneLight::updateLightInfo");

            mMainSceneLightOne = NULL;
        }

        const ObjectPtr lightTwoObject = sceneInfo->findObjectByName("#MainLightTwo");
        ...
        {
            Ogre::LogManager::getSingleton().logMessage("can't find the light with the name '#MainLightTwo' "
                "MainSceneLight::updateLightInfo");
