...
namespace Fairy	{
	...
	//////////////////////////////////////////////////////////////////////////
	BeamElement::BeamElement(const Ogre::String &type, System *system) :
	...
	//---------------------------------------------------------------------
	void BeamElement::updateRenderInstance( Ogre::Real time, TransformInfo &info )
	{
		if ( mBasicNode )
		{
	...
	//---------------------------------------------------------------------
	void BeamElement::_updateBillboardChains( Ogre::Real time )
	{
	...
	//-----------------------------------------------------------------------
	void BeamElement::setMaterialName(const Ogre::String &matName)
	{
	...
	void BeamElement::CmdNoiseXMin::doSet(void* target, const Ogre::String& val)
	{
	...
	void BeamElement::CmdNoiseXMax::doSet(void* target, const Ogre::String& val)
	{
	...
	void BeamElement::CmdNoiseYMin::doSet(void* target, const Ogre::String& val)
	{
	...
	void BeamElement::CmdNoiseYMax::doSet(void* target, const Ogre::String& val)
	{
	...
	void BeamElement::CmdNoiseZMin::doSet(void* target, const Ogre::String& val)
	{
	...
	void BeamElement::CmdNoiseZMax::doSet(void* target, const Ogre::String& val)
	{
	...
	void BeamElement::CmdNumElements::doSet(void* target, const Ogre::String& val)
	{
	...
	void BeamElement::CmdWidth::doSet(void* target, const Ogre::String& val)
	{
	...
	void BeamElement::CmdColour::doSet(void* target, const Ogre::String& val)
	{
	...
	void BeamElement::CmdColourRangeStart::doSet(void* target, const Ogre::String& val)
	{
	...
	void BeamElement::CmdColourRangeEnd::doSet(void* target, const Ogre::String& val)
	{
	...
	void BeamElement::CmdMaterial::doSet(void* target, const Ogre::String& val)
	{
	...
	void BeamElement::CmdFrequency::doSet(void* target, const Ogre::String& val)
	{
