...
class AskLogin : public packet::Base {
 ...
 public: 
   ...
   void get_all_mibao_value(char* buffer, uint16_t length);
   void set_all_mibao_value(const char* all_mibao_value);
 ...
 private:
   ...
   char all_mibao_value_[pap_common_game::define::size::mibao::kUnitNumber][pap_common_game::define::size::mibao::kUnitValueLength + 1]; //密保值
